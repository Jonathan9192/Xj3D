...
public class DefaultNodeFactory
    ...
    private static Map<Float, String[]> globalAvailableProfileNames;

    /** Map of each component to its maximum supported level */
    private static Map<Float, Map<String, Integer>> globalComponentLevels;

    /** Map of node names to their component definitions. */
    private static Map<Float, Map<String, ComponentInfo>> globalNodeNameComponentMap;

    /** Map of a componentInfo to the nodes names as a String[] for it */
    private static Map<Float, Map<String, String[]>> globalComponentToNodeMap;

    /** Map of the node name to the level it belongs to (Integer) */
    private static Map<Float, Map<String, Integer>> globalNodeNameLevelMap;

    /** Mapping of node package to Class instances */
    private static Map<Float, Map<String, Map<String, Class<?>>>> globalNodeClassMap;

    /** Mapping of un-qualified node names to constructor instances */
    private static Map<Float, Map<String, Map<String, Constructor<?>>>> globalConstructorMap;

    /** Flat list of all profiles (ProfileInfo[]). Only set if someone asks for it */
    private static Map<Float, ProfileInfo[]> globalProfileList;

    /** Flat list of all components (ComponentInfo[]). Only set if someone asks for it */
    private static Map<Float, ComponentInfo[]> globalComponentList;

    /** Flat list of component names to their ComponentInfo. */
    private static Map<Float, Map<String, ComponentInfo>> globalComponentNameMap;

    /** The map of renderers available to their name prefix */
    private static Map<Float, Map<String, String>> globalRendererPrefixMap;

    /** Set of profile names that we've attempted to load but failed to find */
    private static Map<Float, HashSet<String>> globalInvalidProfiles;

    /** Set of component names that we've attempted to load but failed to find */
    private static Map<Float, HashSet<String>> globalInvalidComponents;
    ...
    private static Map<String, VRMLNodeFactory> factoryInstances;
    ...
    static {
        ...
        factoryInstances = new HashMap<String, VRMLNodeFactory>();

        globalAvailableProfileNames = new HashMap<Float, String[]>();
        globalRendererPrefixMap = new HashMap<Float, Map<String, String>>();
        globalComponentLevels = new HashMap<Float, Map<String, Integer>>();
        globalComponentNameMap = new HashMap<Float, Map<String, ComponentInfo>>();
        globalNodeNameComponentMap = new HashMap<Float, Map<String, ComponentInfo>>();
        globalComponentToNodeMap = new HashMap<Float, Map<String, String[]>>();
        globalNodeNameLevelMap = new HashMap<Float, Map<String, Integer>>();

        // These contain a second level of mapping with renderer
        globalNodeClassMap = new HashMap<Float, Map<String, Map<String, Class<?>>>>();
        globalConstructorMap = new HashMap<Float, Map<String, Map<String, Constructor<?>>>>();

        globalProfileList = new HashMap<Float, ProfileInfo[]>();
        globalComponentList = new HashMap<Float, ComponentInfo[]>();

        globalInvalidProfiles = new HashMap<Float, HashSet<String>>();
        globalInvalidComponents = new HashMap<Float, HashSet<String>>();
    }
    ...
    protected DefaultNodeFactory(String rendererID) {
        ...
        currentValidNodes = new HashSet<String>();
    }
...
synchronized(globalRendererPrefixMap) {
        ...
        if(prefix_map == null) {
            ...
            globalComponentToNodeMap.put(specVersion, new HashMap<String, String[]>());
            globalComponentLevels.put(specVersion, new HashMap<String, Integer>());
            globalComponentNameMap.put(specVersion, new HashMap<String, ComponentInfo>());
            globalNodeNameLevelMap.put(specVersion, new HashMap<String, Integer>());
            globalNodeClassMap.put(specVersion, new HashMap<String, Map<String, Class<?>>>());
            globalConstructorMap.put(specVersion, new HashMap<String, Map<String, Constructor<?>>>());
            globalInvalidProfiles.put(specVersion, new HashSet<String>());
            globalInvalidComponents.put(specVersion, new HashSet<String>());
            globalNodeNameComponentMap.put(specVersion, new HashMap<String, ComponentInfo>());
        ...
        if (nodeClassMap == null) {
            nodeClassMap = new HashMap<String, Class<?>>();
    ...
    public ComponentInfo findComponent(String name, int level) {
        ...
        if (ret_val == null) {
            errorReporter.warningReport("Can't find comp: " + name +                                         " level: " + level, null);
        }
    ...
    public synchronized VRMLNode createVRMLNode(String nodeName,
        ...
        try {
            ...
            if(cl != null) {
                ...
                throw new UnsupportedNodeException("Cannot find node implementation: " + nodeName);
            }
    ...
    public Object clone()
        ...
        fac.currentValidNodes = new HashSet<String>();
    ...
    private ComponentInfo processComponentElement(Element compDef) {
        ...
        Map<String, String> package_map = new HashMap<String, String>(5);
