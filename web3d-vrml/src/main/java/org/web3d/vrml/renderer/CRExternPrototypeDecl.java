...
public abstract class CRExternPrototypeDecl extends ExternalPrototypeDecl {
    ...
    private static final Set<String> validVrmlTypes;

    /** Valid set of mime types for X3D support */
    private static final Set<String> validX3DTypes;
    ...
    protected List<EPDInstanceEntry> instanceList;

    /** List of EP instances.  Stored as a list of WeakReferences */
    protected List<WeakReference> wrInstances;
    ...
    public CRExternPrototypeDecl(String name,
        ...
        instanceList = new ArrayList<EPDInstanceEntry>();
        wrInstances = new ArrayList<WeakReference>();
    ...
    protected void finishSetContent(PrototypeDecl protoDef,
        ...
        for(EPDInstanceEntry inst : instances) {
            instance = (CRProtoInstance)inst.instance;
            parent = inst.parent;
            protoCreator.fillinInstance(protoDef, instance, rootSpace);
            instance.setupFinished();

            if(parent != null)
                parent.notifyExternProtoLoaded(inst.idx, instance);

            wrInstances.add(new WeakReference<CRProtoInstance>(instance));
        }
