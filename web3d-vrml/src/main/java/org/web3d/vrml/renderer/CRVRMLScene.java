...
public class CRVRMLScene extends AbstractScene implements VRMLScene {
    ...
    /** Set for doing fast checks on the route existence */
    ...
    private Map<String, VRMLProtoDeclare> protos;

    /** Mapping of all EXTERNPROTO declarations in this scene */
    private Map<String, VRMLExternProtoDeclare> externprotos;
     ...
     */
    public CRVRMLScene(int major, int minor) {
        super(major, minor);

        exportMap = new HashMap<String, String>();
        protos = new HashMap<String, VRMLProtoDeclare>();
        externprotos = new HashMap<String, VRMLExternProtoDeclare>();
     ...
     */
    public Map<String, VRMLProtoDeclare> getProtos() {
        return protos;
    }
     ...
     */
    public Map<String, VRMLExternProtoDeclare> getExternProtos() {
        return externprotos;
    }
    ...
    public void removeNode(VRMLNode node) {
        ...
        if(node == layerSet) {
            List<VRMLNode> sets = getByPrimaryType(TypeConstants.LayerSetNodeType);
     ...
     * @param fromField The source field index
     * @param toNode The destination node
     * @param toField The destination field index
     */
    public void addRoute(VRMLNodeType fromNode,
        ...
        CRROUTE route = new CRROUTE(fromNode, fromField, toNode, toField);
