...
/**
 * A node compressor for Coordinate.  Simple delta encoding.
 *
 * @author Alan Hudson.
 * @version $Revision: 1.5 $
 */
public class CoordinateCompressor implements NodeCompressor {
...
System.out.println("Coordinate Compressor is Broken for now");
/*
        // No need to write field index as we only have one field
...
System.out.println("Coordinate:  dbits: " + dbits + " rbits: " + rbits);
            if (dbits < rbits) {
                bp.pack(0,1);
...
*/
     ...
     *   structure of the document.
     */
    public void fieldValue(String[] values, int num) throws SAVException, VRMLException {
    }
