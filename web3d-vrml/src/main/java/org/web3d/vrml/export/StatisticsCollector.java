...
public class StatisticsCollector implements StringContentHandler,
    ProtoHandler, ScriptHandler, Comparator<Map.Entry<String, Integer>> {
    ...
    private Map<String, Integer> defNum;
    ...
    private Map<Integer, HashSet<String>> nodeFieldMap;

    /** Counts for each fieldType */
    private int[] fieldCounts;

    /** The maximum number of fields a node has */
    ...
    public StatisticsCollector() {
        nodeNum = new HashMap<String, Integer>(128);
        defNum = new HashMap<String, Integer>(128);
        lastDef = 0;
        lastNode = 0;

        counts = new HashMap<String, Integer>(128);
        fieldCounts = new int[31];
        fieldCountStack = new SimpleStack();
        fieldNamesStack = new SimpleStack();
        nodeNumStack = new SimpleStack();
        nodeFieldMap = new HashMap<Integer, HashSet<String>>(128);
        totalNodeCount = 0;
        totalFieldCount = 0;
        parsing = false;
    }

    public Map<String, Integer> getNodeTable() {
        return nodeNum;
    }

    public Map<Integer, HashSet<String>> getFieldTable() {
        return nodeFieldMap;
    }

    public Map<String, Integer> getDEFTable() {
        return defNum;
    }
    ...
    public void startNode(String name, String defName)
        ...
        fieldNamesStack.push(new HashSet<String>());
    ...
    public void endNode() throws SAVException, VRMLException {
        ...
        HashSet<String> names = (HashSet<String>) fieldNamesStack.pop();

        Integer node = (Integer) nodeNumStack.pop();
        if (node == null)
            System.out.println("***Error in end node no nodeNumStack entry");

        HashSet<String> priorNames = nodeFieldMap.get(node);
        if (priorNames == null)
    ...
    public void startField(String name) throws SAVException, VRMLException {
        ...
        HashSet<String> set = (HashSet<String>) fieldNamesStack.peek();
