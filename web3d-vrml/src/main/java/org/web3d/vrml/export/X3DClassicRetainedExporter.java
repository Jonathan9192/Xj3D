...
public class X3DClassicRetainedExporter extends BaseRetainedExporter
    ...
    private HashSet<VRMLNodeTemplate> protoDeclSet;
    ...
    private void init() {
        ...
        protoDeclSet = new HashSet<VRMLNodeTemplate>();
    ...
    private void printFieldValue(VRMLNodeType node, VRMLFieldData data, VRMLFieldDeclaration decl) {
        ...
        switch(data.dataType) {
            ...
            case VRMLFieldData.BOOLEAN_ARRAY_DATA:
                ...
                if(data.booleanArrayValue[len2 - 1]) {
                    p.print("TRUE");
                } else {
                    p.print("FALSE");
                }
            ...
            case VRMLFieldData.INT_ARRAY_DATA:
                ...
                p.print(data.intArrayValue[len2 - 1]);
                p.println("]");
            ...
            case VRMLFieldData.LONG_ARRAY_DATA:
                ...
                p.print(data.longArrayValue[len2 - 1]);
                p.println("]");
                break;
            ...
            case VRMLFieldData.FLOAT_ARRAY_DATA:
                ...
                if (ismf) {
                    ...
                    if (len2 > 0) {
                        ...
                        for(int j=0; j < len2; j++) {
                            for(int k=0; k < span; k++) {
                                DoubleToString.appendFormatted(sb,data.floatArrayValue[idx++],sigDigits);
                    ...
                    for(int j=0; j < len2; j++) {
                        DoubleToString.appendFormatted(sb,data.floatArrayValue[j],sigDigits);
            ...
            case VRMLFieldData.STRING_ARRAY_DATA:
                ...
                if (len2 > 0) {
					...
					p.print("\"");
					p.print(data.stringArrayValue[len2 - 1]);
					p.print("\"");
				}
                p.println("]");
                break;
