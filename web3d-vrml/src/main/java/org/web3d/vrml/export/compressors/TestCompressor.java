...
public class TestCompressor implements
     NodeCompressor, SceneGraphTraversalSimpleObserver {
    /** Traverser for printing proto's */
    private SceneGraphTraverser traverser;

    /** The OGL node factory to get default values from */
    protected OGLNodeFactory factory;
    ...
    public TestCompressor() {
        factory = OGLNodeFactory.getOGLNodeFactory();
