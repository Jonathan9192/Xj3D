...
/**
 * A node compressor for CoordinateInterpolator nodes.  Uses delta encoding on the
 * key field as most are small increments.
 *
 * @author Alan Hudson.
 * @version $Revision: 1.4 $
 */
public class CoordinateInterpolatorCompressor implements NodeCompressor {
    ...
    public void fieldValue(String value) throws SAVException, VRMLException {
        ...
        // TODO: Convert over to check whether delta compression should be used
        try {
            if (currentField == 0) {
