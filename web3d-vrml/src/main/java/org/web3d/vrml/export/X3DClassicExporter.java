...
public class X3DClassicExporter extends Exporter {
    ...
    private org.web3d.util.HashSet<String> defTable;
    ...
    public X3DClassicExporter(OutputStream os,
        ...
        fieldDefaults = new HashMap<String, String>();
        ...
        defTable = new org.web3d.util.HashSet<String>();
