...
public interface TypeConstants {
    ...
    public int GeoSRFParamNodeType = 98;

    /** Primary type for Geospatial SRF Info Parameters */
    public int GeoSRFParamInfoNodeType = 99;

    /** Primary type for Geospatial SRFT Parameters */
    public int GeoSRFTParamNodeType = 100;
    
    /** Primary type for BREP node*/
    public int BREPNodeType=101;
    
    /** Secondary type for BREP nodes */
    public int BREPPointBREPType = 102;
    public int BREPWireBREPType = 103;
    public int BREPShellBREPType = 104;
    public int BREPSolidBREPType = 105;

    /** Primary type for origin managed nodes */
    public int OriginManagedNodeType = 101;
