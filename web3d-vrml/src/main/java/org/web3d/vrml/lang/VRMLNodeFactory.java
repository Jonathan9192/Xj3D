...
public interface VRMLNodeFactory {
     ...
     */
    void disableComponent(int[] specVersion, String componentName, int level);
     ...
     *    this implementation
     */
    ComponentInfo addComponent(String name, int level)
     ...
     */
    ComponentInfo findComponent(String name, int level);
     ...
     */
    ProfileInfo findProfile(String name);
     ...
     */
    VRMLNode createVRMLNode(String nodeName,
                                   boolean staticNode)
     ...
     *    profile and components
     */
    VRMLNode createVRMLNode(String component,
                                   String nodeName,
                                   boolean staticNode)
