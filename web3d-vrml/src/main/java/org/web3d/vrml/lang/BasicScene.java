...
public interface BasicScene {
     ...
     */
    List<VRMLNodeTemplate> getNodeTemplates();
     ...
     */
    List<VRMLNode> getByPrimaryType(int type);
     ...
     * @return The list of node instances in this scene.
     */
    List getBySecondaryType(int type);
     ...
     */
    VRMLNodeTemplate getNodeTemplate(String name);
     ...
     */
    Map<String, VRMLNode> getDEFNodes();
     ...
     */
    Map<String, VRMLNode> getImports();
}
