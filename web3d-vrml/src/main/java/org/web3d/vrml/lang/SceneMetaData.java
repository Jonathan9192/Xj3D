...
public class SceneMetaData {
    ...
    /**
     * Create a new, non-writable instance that copies the information from
     * the given source
     *
    ...
    public SceneMetaData(SceneMetaData src) {
        ...
        components = new ArrayList<ComponentInfo>(src.components);
        metaData = new HashMap<String, String>(src.metaData);
    }
