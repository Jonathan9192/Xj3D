...
public interface VRMLSingleExternalNodeType extends VRMLExternalNodeType {
     ...
     */
    void setUrl(String[] newUrl, int numValid);
     ...
     */
    boolean checkValidContentType(String mimetype);
     ...
     */
    void setContent(String mimetype, Object content)
