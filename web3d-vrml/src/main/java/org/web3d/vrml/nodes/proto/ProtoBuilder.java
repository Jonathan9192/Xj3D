...
public class ProtoBuilder
     ...
     */
    private Map<String, VRMLNodeType> globalDefMap;

    /** The mapping of global protos for reference in field decls. */
    private Map<String, PrototypeDecl> globalProtoMap;

    /** The mapping of externproto names (key) to node instances (value) */
    private Map<String, ExternalPrototypeDecl> globalExternProtoMap;
     ...
     */
    private Map<String, ImportNodeProxy> importProxyMap;
     ...
     */
    private Map<String, Map<String, VRMLNode>> exportProxyMap;
    ...
    private HashSet<Class<?>> dontLoadTypes;
    ...
    public ProtoBuilder(VRMLNodeFactory fac) throws NullPointerException {
        ...
        defMap = new HashMap<String, VRMLNode>();
        protoMap = new HashMap<String, PrototypeDecl>();
        externProtoMap = new HashMap<String, ExternalPrototypeDecl>();
        importProxyMap = new HashMap<String, ImportNodeProxy>();
        exportProxyMap = new HashMap<String, Map<String, VRMLNode>>();
    ...
    public void startDocument(String uri,
        ...
        if(!init) {
            globalDefMap = new HashMap<String, VRMLNodeType>();
            globalProtoMap = new HashMap<String, PrototypeDecl>();
            globalExternProtoMap = new HashMap<String, ExternalPrototypeDecl>();
            init = true;
        }
    }
    ...
    public void importDecl(String inline, String exported, String imported)
        ...
        Map<String, VRMLNode> exports = exportProxyMap.get(inline);
        if(exports == null) {
            exports = new HashMap<String, VRMLNode>();
    ...
    public void startNode(String name, String defName)
        ...
        if(protoMap.containsKey(name)) {
            ...
            proto_def = globalProtoMap.get(name);
        } else {
            proto_def = globalExternProtoMap.get(name);
        }
    ...
    public void endProtoBody() throws SAVException, VRMLException {
        ...
        if(topOfStack >= 0) {
            ...
            defMap = (Map<String, VRMLNode>) defMapStack.pop();
            importProxyMap = (Map<String, ImportNodeProxy>) importMapStack.pop();
            exportProxyMap = (Map<String, Map<String, VRMLNode>>) exportMapStack.pop();
        } else {
            currentNode = null;
            currentFieldIndex = -1;
     ...
     */
    public void setGlobals(Map<String, VRMLNodeType> defs, Map<String, PrototypeDecl> protos, Map<String, ExternalPrototypeDecl> externProtos) {
        if(defs == null)
            globalDefMap = new HashMap<String, VRMLNodeType>();
        else
            globalDefMap = defs;
