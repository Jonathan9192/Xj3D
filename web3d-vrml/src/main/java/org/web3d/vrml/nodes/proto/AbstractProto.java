...
public abstract class AbstractProto implements VRMLNodeTemplate {
     ...
     */
    protected final List<VRMLFieldDeclaration> fieldDeclList;
    ...
    public AbstractProto(String name,
        ...
        fieldDeclList = new ArrayList<VRMLFieldDeclaration>();
    ...
    public int appendField(VRMLFieldDeclaration field)
        ...
        Integer pos_index = fieldIndexMap.get(name);
        if(pos_index != null) {

            VRMLFieldDeclaration existing =
                    fieldDeclList.get(pos_index.intValue());
    ...
    public void deleteField(int index)
        ...
        VRMLFieldDeclaration decl = fieldDeclList.get(index);
    ...
    public void deleteField(VRMLFieldDeclaration field)
        ...
        Integer index = fieldIndexMap.remove(name);
     ...
     */
    public List<VRMLFieldDeclaration> getAllFields() {
        List<VRMLFieldDeclaration> ret_val = new ArrayList<VRMLFieldDeclaration>();
        ...
        for(int i = 0; i < size; i++) {
            VRMLFieldDeclaration data = fieldDeclList.get(i);
            if(data != null)
                ret_val.add(data);
        }
    ...
    public VRMLFieldDeclaration getFieldDeclaration(int index) {
        return fieldDeclList.get(index);
    }
