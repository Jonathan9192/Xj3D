...
public interface VRMLMultiExternalNodeType extends VRMLExternalNodeType {
     ...
     * @throws InvalidFieldException The field index is not valid for the query
     */
    boolean checkValidContentType(int index, String mimetype)
        throws InvalidFieldException;
     ...
     * example, for images it might want a BufferedImage preference to an
     ...
     * @throws InvalidFieldException The field index is not valid for the query
     */
    Class<?>[] getPreferredClassTypes(int index)
        throws InvalidFieldException;
     ...
     * @throws InvalidFieldException The field index is not valid for the query
     */
    void setContent(int index, String mimetype, Object content)
     ...
     */
    void setLoadedURI(int fieldIdx, String URI);
}
