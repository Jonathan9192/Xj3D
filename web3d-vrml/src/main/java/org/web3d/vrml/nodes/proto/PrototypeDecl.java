...
public class PrototypeDecl extends AbstractProto
     ...
     */
    private Map<Integer, List<ProtoFieldInfo>> isMap;
    ...
    private Map<String, VRMLNode> imports;

    /** The set of DEF names to their nodes */
    private Map<String, VRMLNode> defs;

    /** The set of prototype declarations that are included in this declaration */
    private List<VRMLNodeTemplate> protos;
    ...
    public PrototypeDecl(String name,
        ...
        isMap = new HashMap<Integer, List<ProtoFieldInfo>>();
        fieldValueMap = new IntHashMap();

        routes = new HashSet<ProtoROUTE>();
        imports = new HashMap<String, VRMLNode>();
    ...
    public void addFieldNodeValue(int index, VRMLNodeType node)
        ...
        List<VRMLNode> n_list = (List<VRMLNode>)fieldValueMap.get(index);

        if(n_list == null) {
            n_list = new LinkedList<VRMLNode>();
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        if(o instanceof List) {
            ...
            List<VRMLFieldData> l = (List<VRMLFieldData>)o;
     ...
     * has been used in the right place. If it is unknown (e.g. not yet loaded
     ...
     */
    public Set<ProtoROUTE> getRouteDecls() {
     ...
     */
    public Map<String, VRMLNode> getImportDecls() {
        return imports;
    }
     ...
     */
    public void setDEFMap(Map<String, VRMLNode> map) {
        defs.putAll(map);
    }
     ...
     */
    public Map<String, VRMLNode> getDEFMap() {
        return defs;
    }
     ...
     * @param destField Index of the receiving field
    ...
    public void addIS(String declFieldName, VRMLNodeType destNode, int destField)
        ...
        Integer index = fieldIndexMap.get(declFieldName);
        ...
        VRMLFieldDeclaration src_decl =
            fieldDeclList.get(index.intValue());
        ...
        List<ProtoFieldInfo> dest_list = isMap.get(index);
        if(dest_list == null) {
     ...
     *    fields
     */
    public Map<Integer, List<ProtoFieldInfo>> getISMaps() {
    ...
    public void setValue(int index, int[] value, int numValid)
        ...
        switch(decl.getFieldType()) {
            ...
            default:
                System.err.println("PrototypeDecl setValue(int[]) unknown " +
