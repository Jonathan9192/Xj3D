...
class EAIEventAdapterThreadPool {
    ...
    class EventRecord {
        ...
        /** Reclamation tag associated with buffer */
        int tag;
        ...
        /** Load the EventRecord with useful information for dispatching
          ...
          * @param aTag The reclamation tag associated with the buffer
          */
        void load(
     ...
     */
    private BroadcastThread createThread(BlockingQueue source, BlockingQueue output) {
    ...
    /** Queue an event for broadcast by the worker threads.
      ...
      * @param shippingTag The buffer's reclamation tag
    ...
    /** Utility class for constructing the event broadcast threads
      ...
      * applets.
      */
    class CreateBroadcastThreadAction implements PrivilegedAction<BroadcastThread> {
