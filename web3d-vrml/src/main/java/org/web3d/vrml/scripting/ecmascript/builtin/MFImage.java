...
public class MFImage extends FieldScriptableObject {
    ...
    private ArrayList<SFImage> valueList;
    ...
    public MFImage() {
        ...
        valueList = new ArrayList<SFImage>();
...
*/
    ...
    public void put(int index, Scriptable start, Object value) {
        ...
        if(index >= valueList.size()) {
            ...
            valueList.add((SFImage) value);
            sizeInt.setValue(valueList.size());
        } else if(index >= 0) {
            valueList.set(index, (SFImage) value);
        }
