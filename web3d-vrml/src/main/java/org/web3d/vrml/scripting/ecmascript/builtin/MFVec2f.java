 ...
 */
public class MFVec2f extends FieldScriptableObject {

    private static final String OBJECT_NOT_VEC_MSG =
        "The object you attempted to assign was not an SFVec2f instance";

    /** The properties of this class */
    private ArrayList<SFVec2f> valueList;
    ...
    public MFVec2f() {
        ...
        valueList = new ArrayList<SFVec2f>();
     ...
     * node).
     */
    public MFVec2f(float[] values, int numValid) {
        this();

        workArray = new float[2];
    ...
    public MFVec2f(Object[] args) {
        ...
        for(int i=0; i < args.length; i++) {
            ...
            if(!(args[i] instanceof SFVec2f))
                    throw new IllegalArgumentException("Non SFVec2f given");

            cnt++;
            valueList.add((SFVec2f) args[i]);
        }
    ...
    public static Scriptable jsConstructor(Context cx, Object[] args,
        ...
        MFVec2f result = new MFVec2f(args);
    ...
    public Object get(int index, Scriptable start) {
        ...
        if((index >= 0) && (index < valueList.size())) {
            ...
            if(ret_val == null) {
                ...
                SFVec2f n = new SFVec2f(workArray);
    ...
    public void put(int index, Scriptable start, Object value) {
        ...
        if(index >= valueList.size()) {
            ...
            for(int i=0; i < toAdd; i++) {
                valueList.add(new SFVec2f());
            }

            valueList.add((SFVec2f) value);
            sizeInt.setValue(valueList.size());
        } else if(index >= 0) {
            valueList.set(index, (SFVec2f) value);
        }
    ...
    public boolean equals(Object val) {
        if(!(val instanceof MFVec2f))
            return false;

        MFVec2f o = (MFVec2f)val;
    ...
    public float[] getRawData() {
        ...
        if((floatData == null) || (floatData.length > (size * 2)))
            floatData = new float[size * 2];
