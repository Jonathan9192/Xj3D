...
//     * @param z The Z component of the vector
     ...
     */
    public SFVec2f jsFunction_add(Scriptable newVector) {
        if (!(newVector instanceof SFVec2f)) {
            Context.reportRuntimeError(INVALID_TYPE_MSG);
        }

        SFVec2f vec = (SFVec2f) newVector;
     ...
     */
    public SFVec2f jsFunction_subtract(Scriptable newVector) {
        if (!(newVector instanceof SFVec2f)) {
            Context.reportRuntimeError(INVALID_TYPE_MSG);
        }
