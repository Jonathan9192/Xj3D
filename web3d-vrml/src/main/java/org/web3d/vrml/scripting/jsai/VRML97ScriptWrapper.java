...
public class VRML97ScriptWrapper implements ScriptWrapper {
    ...
    private List<VRML97ScriptEvent> pendingEvents;

    /** A collection of currently un-used event instances */
    private List<VRML97ScriptEvent> unusedEvents;
    ...
    public void initialize(VRMLScriptNodeType node) {
        ...
        Map<String, Field> fields_map = new HashMap<String, Field>();
        ...
        pendingEvents = new ArrayList<VRML97ScriptEvent>(node.getFieldCount());
        unusedEvents = new LinkedList<VRML97ScriptEvent>();
    ...
    private VRML97ScriptEvent getUnusedEvent() {
        VRML97ScriptEvent ret_val;

        if(unusedEvents.isEmpty())
            ret_val = new VRML97ScriptEvent();
        else
            ret_val = unusedEvents.remove(0);
