...
class InternalBrowser implements Browser {
    ...
    InternalBrowser(VRMLExecutionSpace space,
        ...
        nameToComponentMap = new HashMap<String, ComponentInfo>();

        Map<String, Object> browser_props = new HashMap<String, Object>();
        ...
        Map<String, Object> render_props = new HashMap<String, Object>();
        ...
        for(int i = 0; i < c_list.length; i++) {
            nameToComponentMap.put(c_list[i].getName(),
                                   new SAIComponentInfo(c_list[i]));
       }
        ...
        for(int i = 0; i < p_list.length; i++) {
            ProfileInfo p_info = new SAIProfileInfo(p_list[i]);
     ...
     * @throws ConnectionException An error occurred in the connection to the
     *    browser.
     * @throws NotSupportedException The requested component is not supported
     */
    @Override
