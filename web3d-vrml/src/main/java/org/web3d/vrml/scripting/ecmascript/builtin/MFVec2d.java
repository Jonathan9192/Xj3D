...
public class MFVec2d extends FieldScriptableObject {
    ...
    private ArrayList<SFVec2d> valueList;
    ...
    public MFVec2d() {
        ...
        valueList = new ArrayList<SFVec2d>();
    ...
    public void put(int index, Scriptable start, Object value) {
        ...
        if(index >= valueList.size()) {
            ...
            valueList.add((SFVec2d) value);
            sizeInt.setValue(valueList.size());
        } else if(index >= 0) {
            valueList.set(index, (SFVec2d) value);
        }
