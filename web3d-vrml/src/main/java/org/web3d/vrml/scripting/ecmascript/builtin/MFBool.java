...
public class MFBool extends FieldScriptableObject {
    ...
    public void put(int index, Scriptable start, Object value) {
        ...
        if(index >= valueList.size()) {
            ...
            valueList.set(index, (Boolean) value);
        }
    ...
    /**
     * Get the array of underlying boolean values.
     *
    ...
    public boolean[] getRawData() {
        ...
        for(int i=0; i < valueList.size();i++) {
            ret_val[i] = valueList.get(i).booleanValue();
        }
    ...
    public void getRawData(boolean[] value) {
        for(int i=0; i < valueList.size();i++) {
            value[i] = valueList.get(i).booleanValue();
        }
    }
}
