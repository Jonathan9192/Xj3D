    ...
    synchronized Vector<Object> checkListeners(int fieldID) {
        ...
        if (listenerArray != null) {
            ...
            if (fieldID >= listenerArray.length) {
                ...
                newListenerArray[fieldID] = new Vector<Object>();
                newBuffers[fieldID] = new LinkedList<Object>();
                listenerArray = newListenerArray;
                buffers = newBuffers;
            } else if (listenerArray[fieldID] == null) {
                listenerArray[fieldID] = new Vector<Object>();
                buffers[fieldID] = new LinkedList<Object>();
            }
        } else {
