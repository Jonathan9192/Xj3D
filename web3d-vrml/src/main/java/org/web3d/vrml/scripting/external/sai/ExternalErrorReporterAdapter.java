...
class ExternalErrorReporterAdapter implements ErrorReporter {
    ...
    public void partialReport(String msg) {
        try {
            ...
            System.err.println("Error sending partial report to output");
    ...
    public void messageReport(String msg) {
        try {
            ...
            System.err.println("Error sending message report to output");
            System.err.println(e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public void warningReport(String msg, Exception e) {
        try {
            if(externalReporter != null)
                externalReporter.warningReport(msg, (Exception) e);
            else
                internalReporter.warningReport(msg, (Exception) e);
        } catch(Exception e2) {
            System.err.println("Error sending warning report to output");
    ...
    public void errorReport(String msg, Exception e) {
        try {
            ...
            System.err.println("Error sending error report to output");
            System.err.println(e2.getMessage());
            e2.printStackTrace();
        }
    }
    ...
    public void fatalErrorReport(String msg, Exception e) {
        try {
            ...
            System.err.println("Error sending fatal report to output");
            System.err.println(e2.getMessage());
            e2.printStackTrace();
        }
    }
