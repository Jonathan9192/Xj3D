...
public class MFRotation extends FieldScriptableObject {
    ...
    private static final String OBJECT_NOT_ROT_MSG =
        "The object you attempted to assign was not an SFRotation instance";

    /** The properties of this class */
    private ArrayList<SFRotation> valueList;
    ...
    public MFRotation() {
        ...
        valueList = new ArrayList<SFRotation>();
     ...
     * node).
     */
    public MFRotation(float[] values, int numValid) {
        this();
    ...
    public MFRotation(Object[] args) {
        ...
        for(int i=0; i < args.length; i++) {
            ...
            if(!(args[i] instanceof SFRotation))
                    throw new IllegalArgumentException("Non SFRotation given");

            cnt++;
            valueList.add((SFRotation) args[i]);
        }
    ...
    public static Scriptable jsConstructor(Context cx, Object[] args,
        ...
        MFRotation result = new MFRotation(args);
    ...
    public Object get(int index, Scriptable start) {
        ...
        if((index >= 0) && (index < valueList.size())) {
            ...
            if(ret_val == null) {
                ...
                SFRotation n = new SFRotation(workArray);
    ...
    public void put(int index, Scriptable start, Object value) {
        ...
        Scriptable node = (SFRotation)value;
        ...
        if(index >= valueList.size()) {
            ...
            for(int i=0; i < toAdd; i++) {
                valueList.add(new SFRotation());
            }

            valueList.add((SFRotation) value);
            sizeInt.setValue(valueList.size());
        } else if(index >= 0) {
            valueList.set(index, (SFRotation) value);
        }
    ...
    public String toString() {
        ...
        for(int i = 0; i < size; i++) {
            SFRotation node = valueList.get(i);
    ...
    public boolean equals(Object val) {
        if(!(val instanceof MFRotation))
            return false;

        MFRotation o = (MFRotation)val;
