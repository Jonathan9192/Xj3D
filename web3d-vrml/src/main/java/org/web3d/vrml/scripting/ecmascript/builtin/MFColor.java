...
public class MFColor extends FieldScriptableObject {
    ...
    private ArrayList<SFColor> valueList;
    ...
    public MFColor() {
        ...
        valueList = new ArrayList<SFColor>();
    ...
    public void put(int index, Scriptable start, Object value) {
        ...
        if(index >= valueList.size()) {
            ...
            valueList.add((SFColor) value);
            sizeInt.setValue(valueList.size());
        } else if(index >= 0) {
            valueList.set(index, (SFColor) value);
        }
