    ...
    public VRMLScene createX3DFromURL(String[] urls) {
        ...
        for(int i = 0; i < urls.length; i++) {
            ...
            try {
                ...
                String msg = "I/O error processing url " + urls[i] +
                             " Trying next URL";
                ...
                StringBuilder bldr =
                    new StringBuilder("Parsing error processing URL ");
                bldr.append(urls[i]);

                if(e.getMessage() != null) {
                    bldr.append("Message is ");
                    bldr.append(e.getMessage());
                }

                bldr.append(" Trying next URL");

                errorReporter.errorReport(bldr.toString(), e);
            }
