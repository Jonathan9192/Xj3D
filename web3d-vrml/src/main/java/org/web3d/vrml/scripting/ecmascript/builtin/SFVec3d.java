...
public class SFVec3d extends FieldScriptableObject {
     ...
     */
    public SFVec3d jsFunction_add(Scriptable newVector) {
        if (!(newVector instanceof SFVec3d)) {
            Context.reportRuntimeError(INVALID_TYPE_MSG);
        }

        SFVec3d vec = (SFVec3d)newVector;
     ...
     * @return The product
     */
    public SFVec3d jsFunction_cross(Scriptable newVector) {
        if (!(newVector instanceof SFVec3d)) {
            Context.reportRuntimeError(INVALID_TYPE_MSG);
        }
