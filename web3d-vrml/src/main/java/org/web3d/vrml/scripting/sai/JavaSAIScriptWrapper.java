...
public class JavaSAIScriptWrapper
    ...
    /** Mapping of each field name to its corresponding field object */
    private Map<String, X3DField> fieldMap;

    /** The list of all possible values that have been set for propagation */
    ...
    public JavaSAIScriptWrapper(X3DScriptImplementation sc) {
        ...
        script = sc;
        fieldMap = new HashMap<String, X3DField>();
    ...
    public void initialize(VRMLScriptNodeType node) {
        ...
        List<BaseField> updatables = new ArrayList<BaseField>();
        List<BaseField> node_fields = new ArrayList<BaseField>();
        ...
        pendingEvents = new ArrayList<String>(node.getFieldCount());
    ...
    public boolean sendEvents() {
        ...
        for(int i = 0; i < num_events; i++) {
            String name = pendingEvents.get(i);
    ...
    private void disableFields() {
        ...
        Reference<? extends X3DField> ref;
        BaseField f;
