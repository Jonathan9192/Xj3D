...
class JavascriptBrowserFactory {
     ...
     */
    JavascriptBrowserFactory(BrowserCore browser,
                             RouteManager rm,
        ...
        browsers = new WeakHashMap<VRMLExecutionSpace, JavascriptBrowser>();
     ...
     */
    public JavascriptBrowser getBrowser(VRMLExecutionSpace space) {
        JavascriptBrowser browser = browsers.get(space);

        if(browser == null) {
            browser = new JavascriptBrowser(space,
                                      core,
                                      routeManager,
                                      stateManager,
                                      loadManager);
