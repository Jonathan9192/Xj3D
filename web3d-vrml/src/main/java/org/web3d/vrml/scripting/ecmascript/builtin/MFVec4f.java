 ...
 */
public class MFVec4f extends FieldScriptableObject {

    private static final String OBJECT_NOT_VEC_MSG =
        "The object you attempted to assign was not an SFVec4f instance";

    /** The properties of this class */
    private ArrayList<SFVec4f> valueList;
    ...
    public MFVec4f() {
        ...
        valueList = new ArrayList<SFVec4f>();
     ...
     * node).
     */
    public MFVec4f(float[] values, int numValid) {
        this();
    ...
    public MFVec4f(Object[] args) {
        ...
        for(int i = 0; i < args.length; i++) {
            ...
            if(!(args[i] instanceof SFVec4f))
                    throw new IllegalArgumentException("Non SFVec4f given");

            cnt++;
            valueList.add((SFVec4f) args[i]);
        }
    ...
    public static Scriptable jsConstructor(Context cx, Object[] args,
        ...
        MFVec4f result = new MFVec4f(args);
    ...
    public Object get(int index, Scriptable start) {
        ...
        if((index >= 0) && (index < valueList.size())) {
            ...
            if(ret_val == null) {
                ...
                SFVec4f n = new SFVec4f(workArray);
    ...
    public void put(int index, Scriptable start, Object value) {
        ...
        if(!(value instanceof SFVec4f)) {
            Context.reportError(OBJECT_NOT_VEC_MSG);
            return;
        }

        Scriptable node = (SFVec4f)value;
        ...
        if(index >= valueList.size()) {
            ...
            for(int i=0; i < toAdd; i++) {
                valueList.add(new SFVec4f());
            }

            valueList.add((SFVec4f) value);
            sizeInt.setValue(valueList.size());
        } else if(index >= 0) {
            valueList.set(index, (SFVec4f) value);
        }
    ...
    public boolean equals(Object val) {
        if(!(val instanceof MFVec4f))
            return false;

        MFVec4f o = (MFVec4f)val;
