...
/**
 * BufferedEAIEventAdapter implements the 'broadcast in separate thread'
    ...
    ExternalOutputBufferReclaimer
{
     ...
     * stored grown to accommodate, as they are requested.
        ...
        if (listeners!=null) {
            ...
            while (e.hasMoreElements()) {
                ...
                if (!buffers[fieldID].isEmpty()) {
                    buffer=(ExternalOutputBuffer)((LinkedList<Object>)buffers[fieldID]).removeFirst();
...
*/
    ...
    public void reclaimEventOutBuffer(
        ...
        buffer.reset();
        synchronized (this) {
            ((LinkedList<Object>)buffers[fieldID]).addLast(buffer);
        }
    }
