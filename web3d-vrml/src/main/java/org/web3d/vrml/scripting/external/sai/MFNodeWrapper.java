...
class MFNodeWrapper extends BaseFieldWrapper
    ...
    public void loadOutputValue() {
        ...
        // Found value.nodeArrayValue to be null when loading a primative Box onto a Grid in ChefX3D 07 MAY 2014 TDN
        if ((storedOutputValue == null || storedOutputValue.length!=value.numElements) && value.nodeArrayValue != null) {
