...
public class Matrix4 extends FieldScriptableObject {
    ...
    public Matrix4(double[] data) {
        ...
        // matrix.
        int size = data.length > 16 ? 16 : data.length;
    ...
    public void jsConstructor(double f11, double f12, double f13, double f14,
        ...
        matrix[3] =  Double.isNaN(f14) ? 0 : f14;
        matrix[4] =  Double.isNaN(f21) ? 0 : f21;
        matrix[5] =  Double.isNaN(f22) ? 1 : f22;
        matrix[6] =  Double.isNaN(f23) ? 0 : f23;
        matrix[7] =  Double.isNaN(f24) ? 0 : f24;
        matrix[8] =  Double.isNaN(f31) ? 0 : f31;
        matrix[9] =  Double.isNaN(f32) ? 0 : f32;
        matrix[10] =  Double.isNaN(f33) ? 1 : f33;
        matrix[11] =  Double.isNaN(f34) ? 0 : f34;
        matrix[12] =  Double.isNaN(f41) ? 0 : f41;
        matrix[13] =  Double.isNaN(f42) ? 0 : f42;
        matrix[14] =  Double.isNaN(f43) ? 0 : f43;
     ...
     */
    public Matrix4 jsFunction_multLeft(Scriptable m) {
     ...
     * @return A new matrix with the new values
     */
    public Matrix4 jsFunction_multRight(Scriptable m) {
    ...
    /**
     * Calculate the determinent of this 4x4 matrix. Also provide a temporary
    ...
    /**
     * Find the 3x3 sub-matrix of the source matrix ommitting row i and column j.
     */
