...
class JavaSAIScriptBrowserFactory implements BrowserCoreListener {
    ...
    private Map<VRMLExecutionSpace, InternalBrowser> browsers;
    ...
    JavaSAIScriptBrowserFactory(BrowserCore browser,
        ...
        core.addCoreListener(JavaSAIScriptBrowserFactory.this);

        browsers = new WeakHashMap<VRMLExecutionSpace, InternalBrowser>();
    ...
    public InternalBrowser getBrowser(VRMLExecutionSpace space,
        ...
        InternalBrowser browser = browsers.get(space);
