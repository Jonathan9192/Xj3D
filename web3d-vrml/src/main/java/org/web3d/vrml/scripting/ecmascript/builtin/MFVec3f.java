 ...
 */
public class MFVec3f extends FieldScriptableObject {

    private static final String OBJECT_NOT_VEC_MSG =
        "The object you attempted to assign was not an SFVec3f instance";

    /** The properties of this class */
    private ArrayList<SFVec3f> valueList;
    ...
    public MFVec3f() {
        ...
        valueList = new ArrayList<SFVec3f>();
     ...
     * node).
     */
    public MFVec3f(float[] values, int numValid) {
        this();
    ...
    public MFVec3f(Object[] args) {
        ...
        for(int i=0; i < args.length; i++) {
            ...
            if(!(args[i] instanceof SFVec3f))
                    throw new IllegalArgumentException("Non SFVec3f given");

            cnt++;
            valueList.add((SFVec3f) args[i]);
        }
...
//     * @param nodes The list of nodes to use
    ...
    public static Scriptable jsConstructor(Context cx, Object[] args,
        ...
        MFVec3f result = new MFVec3f(args);
    ...
    public Object get(int index, Scriptable start) {
        ...
        if((index >= 0) && (index < valueList.size())) {
            ...
            if(ret_val == null) {
                ...
                SFVec3f n = new SFVec3f(workArray);
    ...
    public void put(int index, Scriptable start, Object value) {
        ...
        if(index >= valueList.size()) {
            ...
            for(int i=0; i < toAdd; i++) {
                valueList.add(new SFVec3f());
            }

            valueList.add((SFVec3f) value);
            sizeInt.setValue(valueList.size());
        } else if(index >= 0) {
            valueList.set(index, (SFVec3f) value);
        }
    ...
    public boolean equals(Object val) {
        if(!(val instanceof MFVec3f))
            return false;

        MFVec3f o = (MFVec3f)val;
