...
public class SFNode extends NodeFieldObject implements NodeImplSource {
    ...
    public SFNode() {
        ...
        exposedFields = new HashSet<String>();
        eventOuts = new HashSet<String>();
        fields = new HashSet<String>();
        eventIns = new HashSet<String>();
        changedValues = new HashMap<String, Object>();
        nodeFieldNames = new ArrayList<String>();
        fieldObjects = new HashMap<String, Object>();
    }
...
//System.out.println("putting " + node.getVRMLNodeName() + " " +name + "  0x" +hashCode() + " object " + value.hashCode());
        if(fields.contains(name)) {
            if(node.isSetupFinished() || scriptField) {
                ...
                // due to other script reading actions (eg to print out
                // field value.
    ...
    public FieldDefinitionArray jsFunction_getFieldDefinitions() {
        List<X3DFieldDefinition> fields = new ArrayList<X3DFieldDefinition>();
...
//System.out.println("value " + value);
            ...
            List<NodeFieldData> list =
                new ArrayList<NodeFieldData>(size);
