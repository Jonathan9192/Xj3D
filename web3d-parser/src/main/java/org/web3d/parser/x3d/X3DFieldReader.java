...
public class X3DFieldReader implements VRMLFieldReader {
    ...
    private static final Map<String, Boolean> upperBooleanMap;

    /** Lookup table to enable fast boolean parsing using lowercase. */
    private static final Map<String, Boolean> lowerBooleanMap;
     ...
     */
    static {
        upperBooleanMap = new HashMap<String, Boolean>();
        upperBooleanMap.put("TRUE", Boolean.TRUE);
        upperBooleanMap.put("FALSE", Boolean.FALSE);

        lowerBooleanMap = new HashMap<String, Boolean>();
    ...
    public X3DFieldReader() {
        ...
        locator = fieldParser.getDocumentLocator();
    ...
    public boolean[] MFBool(String[] value) throws InvalidFieldFormatException {
        ...
        Map<String, Boolean> map = useLowerBoolean ? lowerBooleanMap : upperBooleanMap;

        for(int i = 0; i < value.length; i++) {
            Boolean bool = map.get(value[i]);
    ...
    /**
     * Parse an MFVec2d value. If there is more than one float value in the string
     * it will be ignored.
     *
     * @param value The raw value as a string to be parsed
     * @return The three components of the vector
    ...
    public float[] SFVec3f(String value) throws InvalidFieldFormatException {
        ...
        try {
            ...
            if (locator != null) {
                throw new InvalidFieldFormatException(pe.getMessage() + ". Value: " + value,
                                                      locator.getLineNumber(),
                                                      locator.getColumnNumber());
            } else {
                throw new InvalidFieldFormatException(pe.getMessage() + ". Value: " + value,
    ...
    public float[] SFRotation(String value) throws InvalidFieldFormatException {
        ...
        try {
            ...
            throw new InvalidFieldFormatException("Invalid field value encountered when parsing SFRotation field value: " + tme.getMessage(),
                                                  locator.getLineNumber(),
                                                  locator.getColumnNumber());
        }
