 ...
 * @version $Id: $
 */
public class QuantizedzlibFloatArrayAlgorithm implements EncodingAlgorithm {
    ...
    public QuantizedzlibFloatArrayAlgorithm(float tolerance) {
    ...
    public void encodeToOutputStream(Object data, OutputStream s) throws IOException {
        ...
        CompressionTools.quantizeFloatArrayDeflater(dos, idata, tolerance, true);
    }
...
//        System.out.println("Decompress: start: " + start + " len: " + length);
        ...
        try {
            return CompressionTools.dequantizeFloatArrayInflater(b, start, length, true);
        } catch(Exception e) {
