...
public class OverlayWrapper implements ComponentListener {
    ...
    private List<VRMLSurfaceNodeType> surfaces;
    ...
    public OverlayWrapper(Component comp) {
        component = comp;
        component.addComponentListener(OverlayWrapper.this);

        surfaces = new ArrayList<VRMLSurfaceNodeType>();
    }
     ...
     */
    public void setSurfaces(List<VRMLSurfaceNodeType> list) {
        surfaces.clear();
    ...
    private void updateSize() {
        ...
        {
            VRMLSurfaceNodeType surf = surfaces.get(i);
