...
public abstract class BaseSurfaceChildNode extends AbstractNode
    ...
    /** The real position of the overlay in screen coordinates */
    ...
    /**
     * Notification from the parent node about this node's visibility state.
     ...
     * proto copying.
     *
     * @param return true if parent visible, false otherwise
     */
   ...
   public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
    ...
    protected void fireSizeChange(int width, int height) {
        ...
        try {
            ...
            System.err.println("Error on surface resize " + e.getMessage());
            e.printStackTrace();
        }
    }
