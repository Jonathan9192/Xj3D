 ...
 */
class NRExternProtoCreator extends CRExternProtoCreator {

    /** The proto instance we're building up */
    private NRProtoInstance protoInstance;
     ...
     */
    public NRExternProtoCreator(String worldURL) {
     ...
     */
    NRProtoInstance createInstance(ExternalPrototypeDecl proto) {
        ...
        protoInstance =
            new NRProtoInstance(proto.getVRMLNodeName(),
                                 isVRML97,
                                 field_decls,
                                 0);
