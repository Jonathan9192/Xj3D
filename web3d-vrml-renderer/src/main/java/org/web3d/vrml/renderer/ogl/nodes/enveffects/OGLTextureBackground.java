...
public class OGLTextureBackground extends BaseTextureBackground
     ...
     */
    static {
        final Map<String, Integer> minMap = new HashMap<String, Integer>(8);
        final Map<String, Integer> magMap = new HashMap<String, Integer>(8);
        ...
        final Map<String, Integer> rescaleMap = new HashMap<String, Integer>(2);
