...
public abstract class BaseBorderLayout extends BaseSurfaceLayoutNode {
    ...
    protected static final Map<String, Integer> alignmentMap;

    /** Set of allowed horizontal alignment field values */
    protected static final HashSet<String> allowedHorizontalValues;

    /** Set of allowed vertical alignment field values */
    protected static final HashSet<String> allowedVerticalValues;
    ...
    static {
        ...
        alignmentMap = new HashMap<String, Integer>();
    ...
    protected void updateManagedNodes() {
        ...
        for(int i = 0; i < vfChildren.length; i++) {
            ...
            Integer align = alignmentMap.get(vfHorizontalAlign);
            ...
            align = alignmentMap.get(vfVerticalAlign);
            switch(align.intValue()) {
                case TOP_ALIGN:
                    // leave x,y as is
                    top = y;
