 ...
 */
public abstract class BaseTextureCoordinate extends BaseGeometricPropertyNode
     ...
     * Empty constructor
     */
    protected BaseTextureCoordinate() {
     ...
     */
    protected BaseTextureCoordinate(VRMLNodeType node) {
        this();
