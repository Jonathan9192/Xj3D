...
public class NRExternPrototypeDecl extends CRExternPrototypeDecl {
     ...
     * declaration.
     *
     * @param name The prototype declaration to base this placeholder on
     ...
     */
    public NRExternPrototypeDecl(String name,
                                 VRMLNodeFactory fac,
                                 int majorVersion,
                                 int minorVersion,
    ...
    public void setContent(String mimetype, Object content)
        ...
        Map<String, VRMLProtoDeclare> protos = scene.getProtos();
        ...
        NRProtoCreator creator =
            new NRProtoCreator(nodeFactory,
                               worldURL,
                               isVrml97 ? 2 : 3,
                               0);
