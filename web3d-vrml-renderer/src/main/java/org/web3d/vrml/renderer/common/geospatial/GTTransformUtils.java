...
public class GTTransformUtils {
     ...
     */
    static {
        allEllipsoidSet = new HashSet<String>();
    ...
    private GTTransformUtils() throws FactoryException {
        ...
        wgs84Ellipsoid = datumFactory.createFlattenedSphere(map,
                                                            ...
                                                            298.257223563,
                                                            SI.METER);
        csDefs = new HashSet<String>();
        utmZoneMap = new HashMap<String, CoordinateOperation>();

        cachedEllipsoidMap = new HashMap<String, Ellipsoid>();
...
System.out.println("Unknown ellipsoid definition passed: " + ellipsoidString);
	...
	private MathTransform createLunarSystemTransform() throws FactoryException {
		...
		if (selenodetic == null) {
			GeotoolsFactory gf = new GeotoolsFactory();
			//try {
				///////////////////////////////////////////////////////////////
				...
				///////////////////////////////////////////////////////////////
				GeodeticDatum datum =
					(GeodeticDatum)((GeographicCRS)selenodetic).getDatum();
		...
		MathTransform mt = co.getMathTransform();
