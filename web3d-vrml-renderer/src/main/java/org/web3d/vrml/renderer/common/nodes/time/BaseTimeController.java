...
public class BaseTimeController extends BaseTimeDependentNode
    ...
    static {
        ...
        fieldMap.put("isActive", new Integer(idx));
        fieldMap.put("isActive_changed", new Integer(idx));

        idx = new Integer(FIELD_FRACTION);
        fieldMap.put("fraction", new Integer(idx));
        fieldMap.put("fraction_changed", new Integer(idx));
    }
    ...
    public void setEnabled(boolean enabled) {
        ...
        if (vfEnabled != enabled) {
            ...
            // setEnable(false) cancels the timer, propogate the remaining state fields
            if (!vfEnabled) {
                if (vfRun) {
                    vfRun = false;
                    if (!inSetup) {
    ...
    public void sendRoute(double time,
        ...
        try {
            ...
            System.err.println("BaseTimeController.sendRoute: No field! " + srcIndex);
            ife.printStackTrace();
