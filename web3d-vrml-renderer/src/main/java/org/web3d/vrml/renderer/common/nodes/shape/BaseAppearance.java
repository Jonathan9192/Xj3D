...
public abstract class BaseAppearance extends AbstractNode
     ...
     */
    private List<MaterialColorListener> colorListeners;
    ...
    public void addMaterialColorListener(MaterialColorListener l) {
        ...
        if(colorListeners == null)
            colorListeners = new ArrayList<MaterialColorListener>();
    ...
    /**
     * Process the images in this texture.  Recursively follow any
