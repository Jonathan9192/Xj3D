 ...
 */
public abstract class BaseRectangle2D extends AbstractNode
   implements VRMLGeometryNodeType {
    ...
    private static final int LAST_RECTANGLE2D_INDEX = FIELD_SIZE;

    /** The number of fields in this node */
    private static final int NUM_FIELDS = LAST_RECTANGLE2D_INDEX + 1;
     ...
     */
    protected BaseRectangle2D(VRMLNodeType node) {
        this();
    ...
    public VRMLFieldDeclaration getFieldDeclaration(int index) {
        if(index < 0  || index > LAST_RECTANGLE2D_INDEX)
            return null;
