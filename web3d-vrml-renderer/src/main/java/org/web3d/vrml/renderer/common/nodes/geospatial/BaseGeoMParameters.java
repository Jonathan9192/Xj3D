 ...
 */
public class BaseGeoMParameters extends BaseGeoSRFTParametersNode {
    ...
    /** The last index of the nodes used by the GeoMParameters */
    protected static final int LAST_TMPARAMS_INDEX = FIELD_ORIGIN_LONGITUDE;
     ...
     * X3D specification.
     */
    public BaseGeoMParameters() {
        super("GeoMParameters");
     ...
     */
    public BaseGeoMParameters(VRMLNodeType node) {
        this();
