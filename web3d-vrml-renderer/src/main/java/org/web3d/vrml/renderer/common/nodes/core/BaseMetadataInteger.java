...
public class BaseMetadataInteger extends BaseMetadataObjectNode {
    ...
    protected static final int LAST_INTEGER_INDEX = FIELD_VALUE;
    ...
    /** The number of valid values in vfValue */
    ...
    static {
        ...
        fieldDecl = new VRMLFieldDeclaration[LAST_INTEGER_INDEX + 1];
        fieldMap = new HashMap<String, Integer>(LAST_INTEGER_INDEX * 3);
    ...
    public BaseMetadataInteger() {
        ...
        hasChanged = new boolean[LAST_INTEGER_INDEX + 1];
        vfValue = FieldConstants.EMPTY_MFINT32;
    }
     ...
     */
    public BaseMetadataInteger(VRMLNodeType node) {
        this();
        ...
        try {
            ...
            if(field.numElements != 0) {
                vfValue = new int[field.numElements];
    ...
    public VRMLFieldDeclaration getFieldDeclaration(int index) {
        if (index < 0  || index > LAST_INTEGER_INDEX)
            return null;
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_VALUE:
                fieldData.clear();
                fieldData.intArrayValue = vfValue;
                fieldData.dataType = VRMLFieldData.INT_ARRAY_DATA;
                fieldData.numElements = numValue;
                break;
    ...
    public void sendRoute(double time,
        ...
        try {
            switch(srcIndex) {
                case FIELD_VALUE:
                    destNode.setValue(destIndex, vfValue, numValue);
                    break;
    ...
    /**
     * Set the value of the field at the given index as an array of int.
     * This would be used to set MFInt32 field type value.
     *
