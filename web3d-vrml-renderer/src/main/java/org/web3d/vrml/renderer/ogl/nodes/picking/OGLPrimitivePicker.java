 ...
 */
public class OGLPrimitivePicker extends BasePrimitivePicker
     ...
     */
    public OGLPrimitivePicker() {
        targetSet = new HashMap<PickableObject, VRMLNode>();
    }
     ...
     */
    public OGLPrimitivePicker(VRMLNodeType node) {
        super(node);
        targetSet = new HashMap<PickableObject, VRMLNode>();
    }
