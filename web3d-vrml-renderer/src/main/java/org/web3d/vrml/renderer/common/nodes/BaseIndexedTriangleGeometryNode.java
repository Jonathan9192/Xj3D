...
public abstract class BaseIndexedTriangleGeometryNode
    ...
    /**
     * Set the fields of the bindable node that has the fields set
    ...
    public void setValue(int index, int[] value, int numValid)
        ...
        if(!inSetup) {
            switch(index) {
                ...
                case FIELD_INDEX:
                    throwInitOnlyWriteException("index");
            ...
            switch(index) {
                ...
                case FIELD_SET_INDEX:
                    throwInputOnlyWriteException("set_index");
     ...
     * objects type and add it to the render sceneGraph.
     *
