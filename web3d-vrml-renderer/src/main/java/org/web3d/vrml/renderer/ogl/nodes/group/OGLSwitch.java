...
public class OGLSwitch extends BaseSwitch
    ...
    private List<VRMLNode> addedChildren;

    /** List of children to remove next update node */
    private List<VRMLNode> removedChildren;
    ...
    public void setupFinished() {
        ...
        oglChildMap = new HashMap<VRMLNode, Node>();
        oglChildList = new ArrayList<Node>();
        ...
        if(!isStatic) {
            removedChildren = new ArrayList<VRMLNode>();
            addedChildren = new ArrayList<VRMLNode>();
        }
