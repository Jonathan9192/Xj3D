...
public class BaseGeoSRFSet extends BaseGeoSRFParametersNode {
    ...
    static {
        ...
        fieldMap.put("ormCode",new Integer(FIELD_ORM_CODE));
        fieldMap.put("srfsCode",new Integer(FIELD_SRFS_CODE));
        fieldMap.put("srfsMember",new Integer(FIELD_SRFS_MEMBER));
    }
    ...
    public VRMLFieldData getFieldValue(int index)
        ...
        switch(index) {
            ...
            case FIELD_SRFS_CODE:
                fieldData.clear();
                fieldData.intArrayValue = vfSrfsCode;
