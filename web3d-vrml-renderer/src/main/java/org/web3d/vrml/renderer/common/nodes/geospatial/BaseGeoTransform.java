...
public class BaseGeoTransform extends BaseGroupingNode implements OriginListener {
    ...
    private void getLocalOrientation(double[] position, Matrix4f mat) {
        ...
        if (local_origin != null) {
            tempVec3d.x += local_origin[0];
            tempVec3d.y += local_origin[1];
            tempVec3d.z += local_origin[2];
        }
        ...
        origQuat.set(
                origQuat.w * rotQuat.x + origQuat.x * rotQuat.w + origQuat.y * rotQuat.z - origQuat.z * rotQuat.y,
                origQuat.w * rotQuat.y + origQuat.y * rotQuat.w + origQuat.z * rotQuat.x - origQuat.x * rotQuat.z,
                origQuat.w * rotQuat.z + origQuat.z * rotQuat.w + origQuat.x * rotQuat.y - origQuat.y * rotQuat.x,
                origQuat.w * rotQuat.w - origQuat.x * rotQuat.x - origQuat.y * rotQuat.y - origQuat.z * rotQuat.z);
        //////////////////////////////////////////////////////////////////
        mat.set(origQuat);
    }
