    ...
    private void setValue(double[] value) {
        ...
        try {
            ...
            if(local_origin == null) {
                ...
                vfValue[0] = (float)(localCoords[0] - local_origin[0]);
                vfValue[1] = (float)(localCoords[1] - local_origin[1]);
                vfValue[2] = (float)(localCoords[2] - local_origin[2]);
            }
