...
public class BaseLoadSensor extends BaseSensorNode
    ...
    protected List<VRMLNodeType> vfWatchList;
    ...
    public BaseLoadSensor() {
        ...
        vfWatchList = new ArrayList<VRMLNodeType>();
        vfTimeout = 0;
        vfProgress = 0;
        vfIsLoaded = false;
        loadCnt = 0;
     ...
     * up geometry, then go for it now.  It is then responsible for calling
     * its children's setupFinished.
     */
    @Override
    ...
    private void clearChildren() {
        ...
        for(int i = 0; i < watch_size; i++) {
            VRMLNodeType node = vfWatchList.get(i);
