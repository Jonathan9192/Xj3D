...
public class OGLShape extends BaseShape
    ...
    public void setupFinished() {
		...
		// shareCount seems to include itself.
    ...
    private void createAppearance() {
        ...
        // Prototype code to add a material if lighting is desired
        if (o_app == null && forceLighting) {
...
*/
    ...
    private void checkForProxy() {
        if(vfAppearance == null) {
            ...
            // if we are stock, don't put anything in to the pipeline.
            if(solid && ccw) {
                proxyAppearance = null;
                return;
            }
