...
public class BaseGeoLCE3DParameters extends BaseGeoSRFTParametersNode {
    ...
    static {
        ...
        fieldMap.put("lococenter",
                     new Integer(FIELD_LOCOCENTER));
        fieldMap.put("primaryAxis", new Integer(FIELD_PRIMARY_AXIS));
        fieldMap.put("secondaryAxis", new Integer(FIELD_SECONDARY_AXIS));
    }
    ...
    public BaseGeoLCE3DParameters(VRMLNodeType node) {
        ...
        try {
            ...
            vfLococenter[0] = field.floatArrayValue[0];
            vfLococenter[1] = field.floatArrayValue[1];
            vfLococenter[2] = field.floatArrayValue[2];

            index = node.getFieldIndex("primaryAxis");
            field = node.getFieldValue(index);
            vfPrimaryAxis[0] = field.floatArrayValue[0];
            vfPrimaryAxis[1] = field.floatArrayValue[1];
            vfPrimaryAxis[2] = field.floatArrayValue[2];

            index = node.getFieldIndex("secondaryAxis");
            field = node.getFieldValue(index);
            vfSecondaryAxis[0] = field.floatArrayValue[0];
            vfSecondaryAxis[1] = field.floatArrayValue[1];
            vfSecondaryAxis[2] = field.floatArrayValue[2];
    ...
    public VRMLFieldData getFieldValue(int index)
        ...
        switch(index) {
            case FIELD_LOCOCENTER:
                fieldData.clear();
                fieldData.floatArrayValue = vfLococenter;
            ...
            case FIELD_PRIMARY_AXIS:
                fieldData.clear();
                fieldData.floatArrayValue = vfPrimaryAxis;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_SECONDARY_AXIS:
                fieldData.clear();
                fieldData.floatArrayValue = vfSecondaryAxis;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
