 ...
 */
public class BaseGeoLTSEParameters extends BaseGeoSRFTParametersNode {
    ...
    /** The last index of the nodes used by the GeoLTSEarameters */
    ...
    static {
        ...
        fieldMap.put("azimuth", new Integer(FIELD_AZIMUTH));
        fieldMap.put("geodeticLatitude",
                     new Integer(FIELD_GEODETIC_LATITUDE));
        fieldMap.put("geodeticLongitude",
                      new Integer(FIELD_GEODETIC_LONGITUDE));
        fieldMap.put("xFalseOrigin", new Integer(FIELD_X_FALSE_ORIGIN));
        fieldMap.put("yFalseOrigin", new Integer(FIELD_Y_FALSE_ORIGIN));
        fieldMap.put("heightOffset", new Integer(FIELD_HEIGHT_OFFSET));
    }
     ...
     * X3D specification.
     */
    public BaseGeoLTSEParameters() {
        super("GeoLTSEParameters");
     ...
     */
    public BaseGeoLTSEParameters(VRMLNodeType node) {
        this();
    ...
    public void setValue(int index, double value)
        ...
        switch(index) {
            ...
            case FIELD_HEIGHT_OFFSET:
                if(!inSetup)
                    throwInitOnlyWriteException("heighOffset");
