...
import org.web3d.vrml.renderer.common.nodes.cadgeometry.BaseCADAssembly;
 ...
 */
public class OGLCADAssembly extends BaseCADAssembly
     ...
     */
    public OGLCADAssembly(VRMLNodeType node) {
        super(node);
