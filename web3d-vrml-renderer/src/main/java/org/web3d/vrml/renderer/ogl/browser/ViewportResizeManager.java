...
class ViewportResizeManager
    ...
    private List<Viewport> fullscreenViewports;

    /** The list of fixed size viewports to manage */
    private List<FixedViewportData> fixedViewports;

    /** The list of custom size viewports to manage */
    private List<CustomViewportData> customViewports;

    /** The list of proportional viewports to manage */
    private List<ProportionalViewportData> proportionalViewports;

    /** The mapping of a view to its ViewportData type. */
    private Map<Viewport, Object> viewDataMap;
    ...
    ViewportResizeManager() {
        customViewports = new ArrayList<CustomViewportData>();
        fixedViewports = new ArrayList<FixedViewportData>();
        fullscreenViewports = new ArrayList<Viewport>();
        proportionalViewports = new ArrayList<ProportionalViewportData>();

        viewDataMap = new HashMap<Viewport, Object>();
    ...
    void removeFixedViewport(VRMLViewportNodeType node, Viewport view) {
        ...
        FixedViewportData data = (FixedViewportData) viewDataMap.remove(view);
    ...
    void removeProportionalViewport(VRMLViewportNodeType node, Viewport view) {
        ...
        ProportionalViewportData data = (ProportionalViewportData) viewDataMap.remove(view);
    ...
    void removeCustomViewport(VRMLViewportNodeType node, Viewport view) {
        ...
        CustomViewportData data = (CustomViewportData) viewDataMap.remove(view);
    ...
    private void processViewportChange(FixedViewportData data) {
        ...
        int width = data.viewWidth;
        int height = data.viewHeight;
