 ...
 * <p>
 *
 * The point set directly maps to Aviatrix3D's IndexedTriangleFanArray class. When the
 ...
 */
public class OGLIndexedTriangleFanSet extends BaseIndexedTriangleFanSet
     ...
     */
    public OGLIndexedTriangleFanSet() {
        init();
    }
     ...
     */
    public OGLIndexedTriangleFanSet(VRMLNodeType node) {
        super(node);
    ...
    public void updateNodeBoundsChanges(Object src) {
        ...
        if(coordChanged) {
            if(vfCoord == null) {
                ...
                implGeom.setVertices(IndexedTriangleFanArray.COORDINATE_3,
        ...
        if(indexChanged) {
            if (indexed) {
                IndexedTriangleFanArray itfa = (IndexedTriangleFanArray) implGeom;
                itfa.setIndices(processedIndex, numProcessedIndex);
                itfa.setFanCount(fanCounts, numFanCounts);
            }
    ...
    protected void buildImpl() {
        ...
        if (vfNormal != null) {
            ...
            if (!indexed || implGeom == null) {
                implGeom = new IndexedTriangleFanArray(true, VertexGeometry.VBO_HINT_STATIC);
			...
			// TODO: Triangulation may be incorrect for vfCcw FALSE

            gutils.generateTriangleArrays(changeFlags, false, true,
               vfCoord, vfColor, vfNormal, vfTexCoord,
               vfIndex, numIndex, vfIndex, vfIndex,
               vfIndex, vfCcw, true, true, vfNormalPerVertex,
