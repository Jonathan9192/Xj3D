    ...
    public void setValue(int index, int[] value, int numValid)
        ...
        switch(index) {
            ...
            case FIELD_SET_COLORINDEX:
                if(inSetup)
                    throwInputOnlyWriteException("set_colorIndex");
            ...
            case FIELD_SET_NORMALINDEX:
                if(inSetup)
                    throwInputOnlyWriteException("set_normalIndex");
            ...
            case FIELD_SET_TEXCOORDINDEX:
                if(inSetup)
                    throwInputOnlyWriteException("set_texCoordIndex");
            ...
            case FIELD_COLORINDEX :
                if(!inSetup)
                    throwInitOnlyWriteException("colorIndex");
            ...
            case FIELD_NORMALINDEX :
                if(!inSetup)
                    throwInitOnlyWriteException("normalIndex");
            ...
            case FIELD_TEXCOORDINDEX :
                if(!inSetup)
                    throwInitOnlyWriteException("texCoordIndex");
