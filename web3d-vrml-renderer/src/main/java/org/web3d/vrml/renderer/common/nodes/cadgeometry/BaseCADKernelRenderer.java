...
public abstract class BaseCADKernelRenderer implements CADKernelType {
    ...
    static List<BaseCADKernelRenderer> instanciatedRenderers = new ArrayList<BaseCADKernelRenderer>();
    ...
    protected ArrayList<Vector<VRMLNode>> relations = new ArrayList<Vector<VRMLNode>>();

    public BaseCADKernelRenderer() {
        instanciatedRenderers.add(this);
    }
    ...
    public void addRelationToThisInstance(VRMLNodeType n1, VRMLNodeType n2) {
        ...
        Vector<VRMLNode> v = new Vector<VRMLNode>();
        v.add(n1);
        v.add(n2);
        relations.add(v);
    }
    ...
    public List<VRMLNode> getLinkedObjectsFrom(VRMLNode o) {
        List<VRMLNode> al = new ArrayList<VRMLNode>();
