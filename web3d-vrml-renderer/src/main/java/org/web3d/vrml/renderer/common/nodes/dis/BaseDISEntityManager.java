...
public abstract class BaseDISEntityManager extends AbstractNode
    ...
    private static HashMap<String, Integer> fieldMap;
    ...
    /** mapping MFNode [] */
    protected ArrayList<VRMLNodeType> vfMapping;

    /** addedEntities MFNode [] */
    protected ArrayList<VRMLNodeType> vfAddedEntities;

    /** removedEntities MFNode [] */
    protected ArrayList<VRMLNodeType> vfRemovedEntities;
    ...
    public BaseDISEntityManager() {
        ...
        vfPort = 0;
        vfAddress = "";
        vfAddedEntities = new ArrayList<VRMLNodeType>();
        vfRemovedEntities = new ArrayList<VRMLNodeType>();
        vfMapping = new ArrayList<VRMLNodeType>();
    }
