...
public class BaseCustomViewport extends AbstractNode
    ...
    static {
        ...
        fieldMap.put("fixedX", new Integer(FIELD_FIXED_X));
        fieldMap.put("fixedY", new Integer(FIELD_FIXED_Y));
        fieldMap.put("fixedWidth", new Integer(FIELD_FIXED_WIDTH));
        fieldMap.put("fixedHeight", new Integer(FIELD_FIXED_HEIGHT));
    }
