...
public class OGLAppearance extends BaseAppearance
    ...
    static {
        texGenModeMap = new HashMap<String, Integer>(3);
    ...
    public void textureImageChanged(
        ...
        if (idx < numStages && vrmlTexs != null) {
            ...
            case TextureConstants.TYPE_SINGLE_2D:
                ...
                // deliberate fallthrough is permitted to the following case
                //////////////////////////////////////////////////////////////////
...
*/
    ...
    public void updateNodeDataChanges(Object src) {
        if(src == oglImplNode) {
            ...
            texUnitsChanged.remove((TextureUnit)src);
            ...
            if(ts != null) {
                ...
                changedTransforms.remove((TextureUnit)src);
            }
            ...
            if(ts != null) {
                ...
                changedTexCoordGeneration.remove((TextureUnit)src);
            }
        }
    }
    ...
    private void init() {
        ...
        texGenMap = new HashMap<Integer, String>(2);

        changedTransforms = new HashMap<TextureUnit, TextureStage>();
        changedTexCoordGeneration = new HashMap<TextureUnit, TextureStage>();
        ...
        texUnitsChanged = new ConcurrentLinkedQueue<SceneGraphObject>();
    }
    ...
    private void createTextureUnits() {
        ...
        for(int i = currStage; i < numStages; i++) {
            ...
            case TextureConstants.TYPE_SINGLE_2D:
                ...
                String modeString =
                    texGenMap.get(new Integer(currStage));
            ...
            case TextureConstants.TYPE_SINGLE_3D:
                ...
                modeString = texGenMap.get(new Integer(currStage));
