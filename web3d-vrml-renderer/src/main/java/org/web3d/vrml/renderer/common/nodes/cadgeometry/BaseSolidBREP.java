 ...
 */
public abstract class BaseSolidBREP extends AbstractNode
  ...
  //  protected static final int FIELD_RADIUS = LAST_NODE_INDEX + 2;
    ...
    protected static final int LAST_SOLIDBREP_INDEX = LAST_NODE_INDEX+1;

    /** Number of fields constant */
    protected static final int NUM_FIELDS = LAST_NODE_INDEX + 1;
...
//        vfSolid = true;
     ...
     */
    public BaseSolidBREP(VRMLNodeType node) {
        this();
...
/*
    ...
    public VRMLFieldDeclaration getFieldDeclaration(int index) {
        if(index < 0  || index > LAST_SOLIDBREP_INDEX)
            return null;
    ...
    public void setValue(int index, boolean value)
        ...
        switch(index) {
         /*   case FIELD_SOLID:
                ...
                if(!inSetup)
                    throw new InvalidFieldValueException("Cannot write to "  + " solid");
