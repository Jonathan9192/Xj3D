...
public abstract class BaseLinePicker extends BasePickingNode {
    ...
    private static final String PICK_GEOM_MSG = "The pickGeometry type is " +
        "invalid for LinePicker. It must be either LineSet or IndexedLineSet";
    ...
    static {
        ...
        fieldMap.put("pickedNormal",new Integer(FIELD_PICKED_NORMAL));
        fieldMap.put("pickedTextureCoordinate",new Integer(FIELD_PICKED_TEXCOORD));
    }
     ...
     */
    public BaseLinePicker(VRMLNodeType node) {
        this();
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_PICKED_NORMAL:
                fieldData.clear();
                fieldData.floatArrayValue = vfPickedNormal;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = numPickedItems;
                break;
            ...
            case FIELD_PICKED_TEXCOORD:
                fieldData.clear();
                fieldData.floatArrayValue = vfPickedTextureCoordinate;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = numPickedItems;
                break;
