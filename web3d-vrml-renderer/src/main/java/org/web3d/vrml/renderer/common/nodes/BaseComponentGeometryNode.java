...
//	public static final int VBO_MIN_VERTICES = 1000;
    public static final int VBO_MIN_VERTICES = 13;
    ...
    /** Index of the attribute's exposedField */
    ...
    protected List<VRMLNodeType> vfAttribs;
    ...
    protected BaseComponentGeometryNode(String name) {
        ...
        vfAttribs = new ArrayList<VRMLNodeType>(1);
    ...
    public void setTextureCount(int count) {
        // default does nothing at this point. Individual nodes need to
...
// Also need to add VRMLNodeType[] variant for the attribs field too.
    ...
    protected void fireLocalColorsChanged(boolean enabled) {
        ...
        for(LocalColorsListener l : localColorsListeners) {
            try {
