 ...
 * <p>
 *
 * The point set directly maps to Aviatrix3D's IndexedQuadArray class. When the
 ...
 * copied from the OGLQuadSet node by Alan Hudson, with incorporation of the
 * 'index' node attribute.
 */
public class OGLIndexedQuadSet extends BaseIndexedQuadSet
     ...
     */
    public OGLIndexedQuadSet(VRMLNodeType node) {
        super(node);
    ...
    public void updateNodeBoundsChanges(Object src) {
        ...
        if(vfCoord == null) {
            ...
            implGeom.setVertices(IndexedQuadArray.COORDINATE_3, tmp, num_points / 3);
            implGeom.setIndices(vfCoordIndex, numCoordIndex);
        }
    }
        ...
        if(texCoordChanged) {
            if(vfTexCoord == null) {
                ...
                for(int i = 0; i < num_tex_sets; i++) {
                    ...
                    switch(type) {
                        case 1:
                            tmpTexTypes[i] = IndexedQuadArray.TEXTURE_COORDINATE_1;
                            break;

                        case 2:
                            tmpTexTypes[i] = IndexedQuadArray.TEXTURE_COORDINATE_2;
                            break;

                        case 3:
                            tmpTexTypes[i] = IndexedQuadArray.TEXTURE_COORDINATE_3;
                            break;

                        case 4:
                            tmpTexTypes[i] = IndexedQuadArray.TEXTURE_COORDINATE_4;
                            break;
