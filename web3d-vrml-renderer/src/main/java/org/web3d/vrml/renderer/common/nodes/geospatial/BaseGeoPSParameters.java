 ...
 */
public class BaseGeoPSParameters extends BaseGeoSRFTParametersNode {
    ...
    /** Index of the polarAspect field */
    protected static final int FIELD_POLAR_ASPECT =
        LAST_SRFT_PARAM_INDEX + 5;

    /** The last index of the nodes used by the GeoPSParameters */
    protected static final int LAST_ECPARAMS_INDEX = FIELD_POLAR_ASPECT;

    /** Number of fields constant */
    private static final int NUM_FIELDS = LAST_ECPARAMS_INDEX + 1;

    /** Valid type set for the polarAspect field */
    private static final HashSet<String> VALID_POLAR_ASPECTS;
    ...
    /** initializeOnly SFString polarAspect NORTH */
    protected String vfPolarAspect;
    ...
    static {
        ...
        fieldMap.put("originLongitude", new Integer(FIELD_ORIGIN_LONGITUDE));
        fieldMap.put("polarAspect", new Integer(FIELD_POLAR_ASPECT));

        VALID_POLAR_ASPECTS = new HashSet<String>();
        VALID_POLAR_ASPECTS.add("NORTH");
        VALID_POLAR_ASPECTS.add("SOUTH");
    }
     ...
     * X3D specification.
     */
    public BaseGeoPSParameters() {
        super("GeoPSParameters");
     ...
     */
    public BaseGeoPSParameters(VRMLNodeType node) {
        this();
        ...
        try {
            ...
            index = node.getFieldIndex("polarAspect");
            field = node.getFieldValue(index);
            vfPolarAspect = field.stringValue;
    ...
    public VRMLFieldDeclaration getFieldDeclaration(int index) {
        return (index < 0 || index > LAST_ECPARAMS_INDEX) ?
    ...
    public VRMLFieldData getFieldValue(int index)
        ...
        switch(index) {
            ...
            case FIELD_POLAR_ASPECT:
                fieldData.clear();
                fieldData.stringValue = vfPolarAspect;
    ...
    public void setValue(int index, String value)
        ...
        switch(index) {
            case FIELD_POLAR_ASPECT:
                if(!inSetup)
                    throwInitOnlyWriteException("polarAspect");

                if(!VALID_POLAR_ASPECTS.contains(value))
                    throw new InvalidFieldValueException(value, "polarAspect");
