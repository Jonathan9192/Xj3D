...
import org.j3d.geom.particle.PointEmitter;
 ...
 */
public abstract class BasePointEmitter extends BaseEmitter {

    /** The default direction of a point emitter - Straight up */
    protected static final float[] DEFAULT_DIRECTION = {0, 1, 0};

    // Field index constants

    /** The field index for direction */
    protected static final int FIELD_DIRECTION = LAST_EMITTER_INDEX + 1;

    /** The field index for velocity */
    protected static final int FIELD_POSITION = LAST_EMITTER_INDEX + 2;

    /** The last field index used by this class */
    protected static final int LAST_POINT_EMITTER_INDEX = FIELD_POSITION;

    /** Number of fields constant */
    protected static final int NUM_FIELDS = LAST_POINT_EMITTER_INDEX + 1;
    ...
    protected BasePointEmitter() {
        ...
        initializer = new PointEmitter();
        ((PointEmitter)initializer).setDirection(0, 1, 0);
     ...
     */
    public BasePointEmitter(VRMLNodeType node) {
        this();
        ...
        try {
            ...
            ((PointEmitter)initializer).setDirection(vfDirection[0],
                                                     vfDirection[1],
                                                     vfDirection[2]);
            ((PointEmitter)initializer).setPosition(vfPosition[0],
                                                    vfPosition[1],
                                                    vfPosition[2]);
    ...
    public VRMLFieldDeclaration getFieldDeclaration(int index) {
        if (index < 0  || index > LAST_POINT_EMITTER_INDEX)
            return null;
   ...
   public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
    ...
    protected void setPosition(float[] pos) {
        ...
        ((PointEmitter)initializer).setPosition(pos[0], pos[1], pos[2]);
    ...
    protected void setDirection(float[] dir) {
        ...
        ((PointEmitter)initializer).setDirection(dir[0], dir[1], dir[2]);
