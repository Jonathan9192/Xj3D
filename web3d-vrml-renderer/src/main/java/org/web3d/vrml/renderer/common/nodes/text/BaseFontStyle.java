...
public abstract class BaseFontStyle extends AbstractNode
    ...
    /** Error message for when the justify major type is invalid */
    private static final String MAJOR_JUSTIFY_ERR_MSG =
        "Invalid justify enumerant value for the major type: ";

    /** Error message for when the justify minor type is invalid */
    ...
    protected static final Map<String, Integer> justifyMap;

    /** Mapping of the style field string to the internal int type */
    protected static final Map<String, Integer> styleMap;

    /** Mapping of the family field string to the internal Font name type */
    protected static final Map<String, String> fontMap;

    /**
     * The set of all available font family names. Used for fast lookups when
     * creating new instances of this class.
     */
    private static final HashSet<String> systemFontFamilies;
    ...
    static {
        ...
        justifyMap = new HashMap<String, Integer>();
        ...
        systemFontFamilies = new HashSet<String>();
        ...
        Integer prop = AccessController.doPrivileged(
    ...
    public BaseFontStyle() {
        ...
        String fam = fontMap.get(DEFAULT_FAMILY);
    ...
    public BaseFontStyle(VRMLNodeType node) {
        ...
        try {
            ...
            if(field.numElements != 0) {
                ...
                System.arraycopy(tmp, 0, vfFamily, 0, field.numElements);
            }
    ...
    //----------------------------------------------------------
    // Methods defined by VRMLFontStyleNodeType interface.
    //----------------------------------------------------------
    ...
    public void setupFinished() {
        ...
        for(int i = 0; i < vfFamily.length; i++) {
            if(systemFontFamilies.contains(vfFamily[i])) {
                ...
                selectedFamilyFont = fontMap.get(vfFamily[i]);
                break;
            }
        ...
        Map<TextAttribute, Object> font_attr = new HashMap<TextAttribute, Object>();
        ...
        Integer style = styleMap.get(vfStyle);
        ...
        if(vfHorizontal) {
            if(vfJustify[0] != null) {
                tmp = justifyMap.get(vfJustify[0]);
                horizontalJustification = tmp.intValue();
            }

            if(vfJustify[1] != null) {
                tmp = justifyMap.get(vfJustify[1]);
