...
public abstract class BaseCollision extends BaseGroupingNode
    ...
    static {
        ...
        fieldMap = new HashMap<String, Integer>(NUM_FIELDS * 2);
        ...
        fieldMap.put("proxy",FIELD_PROXY);
        fieldMap.put("collideTime",FIELD_COLLIDE_TIME);
        fieldMap.put("isActive",FIELD_ISACTIVE);
