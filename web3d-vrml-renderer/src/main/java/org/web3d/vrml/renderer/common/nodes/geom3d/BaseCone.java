 ...
 */
public abstract class BaseCone extends AbstractNode
    implements VRMLGeometryNodeType {

    /** Index of the solid field */
    protected static final int FIELD_SOLID = LAST_NODE_INDEX + 1;

    /** Field Index for bottomRadius */
    protected static final int FIELD_BOTTOM_RADIUS = LAST_NODE_INDEX + 2;

    /** Field Index for height */
    protected static final int FIELD_HEIGHT = LAST_NODE_INDEX + 3;

    /** Field Index for bottom */
    protected static final int FIELD_BOTTOM = LAST_NODE_INDEX + 4;

    /** Field Index for side */
    protected static final int FIELD_SIDE = LAST_NODE_INDEX + 5;

    /** The last index in this node */
    protected static final int LAST_CONE_INDEX = FIELD_SIDE;

    /** Number of fields constant */
    protected static final int NUM_FIELDS = LAST_CONE_INDEX + 1;
    ...
    static {
        ...
        fieldMap.put("bottomRadius", new Integer(FIELD_BOTTOM_RADIUS));
     ...
     */
    protected BaseCone(VRMLNodeType node) {
        this();
        ...
        try {
            ...
            index = node.getFieldIndex("bottomRadius");
            field = node.getFieldValue(index);
            vfBottomRadius = field.floatValue;
    ...
    public VRMLFieldDeclaration getFieldDeclaration(int index) {
        if(index < 0  || index > LAST_CONE_INDEX)
            return null;
    ...
    public VRMLFieldData getFieldValue(int index)
        ...
        switch(index) {
            ...
            case FIELD_BOTTOM_RADIUS:
                fieldData.clear();
                fieldData.floatValue = vfBottomRadius;
    ...
    public void setValue(int index, float value)
        ...
        switch(index) {
            ...
            case FIELD_BOTTOM_RADIUS:
                if(!inSetup)
                    throwInitOnlyWriteException("bottomRadius");

                vfBottomRadius = value;
                break;
