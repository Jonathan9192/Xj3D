...
public abstract class BasePositionInterpolator2D extends BaseInterpolatorNode {
     ...
     * locally.
     */
    protected BasePositionInterpolator2D() {
        super("PositionInterpolator2D");

        hasChanged = new boolean[NUM_FIELDS];

        vfKeyValue = FieldConstants.EMPTY_MFVEC2F;
        vfValue = new float[] {0, 0};
    }
     ...
     */
    protected BasePositionInterpolator2D(VRMLNodeType node) {
        this();
        checkNodeType(node);
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_KEY_VALUE:
                ...
                fieldData.numElements = numKeyValue / 2;
                break;
    ...
    public void sendRoute(double time,
        ...
        try {
            switch(srcIndex) {
                ...
                case FIELD_VALUE:
                    destNode.setValue(destIndex, vfValue, 2);
                    break;
