 ...
 */
public abstract class BasePrimitivePicker extends BasePickingNode {
    ...
    private static final String PICK_GEOM_MSG = "The pickGeometry type is " +
        "invalid for PrimitivePicker. It must be one of Box, Cone, Cylinder " +
        "or Sphere";
    ...
    static {
        ...
        validPrimitiveTypes = new HashMap<String, Integer>();

        validPrimitiveTypes.put("Box", new Integer(BOX_PICK));
        validPrimitiveTypes.put("Cone", new Integer(CONE_PICK));
        validPrimitiveTypes.put("Cylinder", new Integer(CYLINDER_PICK));
        validPrimitiveTypes.put("Sphere", new Integer(SPHERE_PICK));
    }
     ...
     */
    public BasePrimitivePicker(VRMLNodeType node) {
        this();
