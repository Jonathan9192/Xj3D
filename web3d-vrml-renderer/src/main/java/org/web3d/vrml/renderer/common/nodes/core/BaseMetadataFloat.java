 ...
 */
public class BaseMetadataFloat extends BaseMetadataObjectNode {

    /** Index of the url field */
    protected static final int FIELD_VALUE = LAST_METADATA_INDEX + 1;

    /** The last field index used by this class */
    protected static final int LAST_FLOAT_INDEX = FIELD_VALUE;
    ...
    static {
        ...
        fieldDecl = new VRMLFieldDeclaration[LAST_FLOAT_INDEX + 1];
        fieldMap = new HashMap<String, Integer>(LAST_FLOAT_INDEX * 3);
     ...
     */
    public BaseMetadataFloat() {
        super("MetadataFloat");

        hasChanged = new boolean[LAST_FLOAT_INDEX + 1];
        vfValue = FieldConstants.EMPTY_MFFLOAT;
    }
     ...
     */
    public BaseMetadataFloat(VRMLNodeType node) {
        this();
        ...
        try {
            ...
            if(field.numElements != 0) {
                vfValue = new float[field.numElements];
    ...
    public VRMLFieldDeclaration getFieldDeclaration(int index) {
        if (index < 0  || index > LAST_FLOAT_INDEX)
            return null;
     ...
     * This would be used to set MFFloat field type url.
     *
