...
public abstract class BaseRenderedTexture extends BaseTexture2DNode
    ...
    protected static final Map<String, Integer> updateMap;
    ...
    static {
        ...
        fieldMap.put("dimensions", FIELD_DIMENSIONS);
        fieldMap.put("repeatS", FIELD_REPEATS);
        fieldMap.put("repeatT", FIELD_REPEATT);

        updateMap = new HashMap<String, Integer>();
        updateMap.put("NONE", UPDATE_NONE);
        updateMap.put("NEXT_FRAME_ONLY", UPDATE_NEXT);
        updateMap.put("ALWAYS", UPDATE_ALWAYS);
    }
    ...
    public BaseRenderedTexture(VRMLNodeType node) {
        ...
        try {
            ...
            Integer id = updateMap.get(vfUpdate);
    ...
    protected void setUpdate(String state) {
        ...
        Integer id = updateMap.get(state);
