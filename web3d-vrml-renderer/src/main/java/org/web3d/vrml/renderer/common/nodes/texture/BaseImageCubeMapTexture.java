 ...
 */
public class BaseImageCubeMapTexture extends BaseTextureNode
    implements VRMLSingleExternalNodeType, VRMLEnvironmentTextureNodeType {
    ...
    /** Field Index */
    private static final int FIELD_URL = LAST_NODE_INDEX + 1;
     ...
     */
    protected BaseImageCubeMapTexture() {
        super("ImageCubeMapTexture");

        contentListeners = new ArrayList<VRMLContentStateListener>();
     ...
     */
    protected BaseImageCubeMapTexture(VRMLNodeType node) {
        this();
