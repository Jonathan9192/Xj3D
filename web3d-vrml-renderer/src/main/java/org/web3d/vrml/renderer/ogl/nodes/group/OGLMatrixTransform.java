...
import org.web3d.vrml.renderer.common.nodes.group.BaseMatrixTransform;
 ...
 */
public class OGLMatrixTransform extends BaseMatrixTransform
     ...
     */
    public OGLMatrixTransform(VRMLNodeType node) {
        super(node);
