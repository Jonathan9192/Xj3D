...
import org.web3d.vrml.renderer.common.nodes.BasePointSetGeometryNode;
 ...
 */
public abstract class BasePointSet extends BasePointSetGeometryNode {
     ...
     */
    protected BasePointSet(VRMLNodeType node) {
        this();
    ...
    /**
     * Specifies whether this node requires lighting. Points are not lit so
     * always return false.
     *
     * @return false
     */
