...
public class BaseMultiTexture extends BaseTextureNode
    ...
    static {
        ...
        modeMap = new HashMap<String, Integer>(19);
        ...
        sourceMap = new HashMap<String, Integer>(4);
        ...
        functionMap = new HashMap<String, Integer>(3);
    ...
    protected BaseMultiTexture() {
        ...
        vfTexture = new ArrayList<VRMLTextureNodeType>();
