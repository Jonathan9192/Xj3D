...
public class OGLIndexedFaceSet extends BaseIndexedFaceSet
    ...
    /**
     * Number of texture sets requested by the appearance. Used when no
     * texture coordinates are available locally
     */
    private int requestedTexSets;
