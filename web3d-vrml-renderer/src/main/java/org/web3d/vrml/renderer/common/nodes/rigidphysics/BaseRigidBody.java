...
public abstract class BaseRigidBody extends AbstractNode
    ...
    private static final HashSet<String> validDensityTypes;
    ...
    /** Helper to fetch the body orientation from ODE */
    private Quaternion4f orientTmp;
    ...
    static {
        ...
        validDensityTypes = new HashSet<String>();
...
//            odeBody.adjustMass(vfMass);
    ...
    public void updateNodeFromODE() {
        ...
        vfPosition[0] = positionTmp.getX();
        vfPosition[1] = positionTmp.getY();
        vfPosition[2] = positionTmp.getZ();
        ...
        vfOrientation[0] = angleTmp.getX();
        vfOrientation[1] = angleTmp.getY();
        vfOrientation[2] = angleTmp.getZ();
        vfOrientation[3] = angleTmp.getAngle();

        hasChanged[FIELD_ORIENTATION] = true;
        fireFieldChanged(FIELD_ORIENTATION);

        odeBody.getLinearVel(positionTmp);
        vfLinearVelocity[0] = positionTmp.getX();
        vfLinearVelocity[1] = positionTmp.getY();
        vfLinearVelocity[2] = positionTmp.getZ();

        hasChanged[FIELD_LINEAR_VELOCITY] = true;
        fireFieldChanged(FIELD_LINEAR_VELOCITY);

        odeBody.getPosition(positionTmp);
        vfAngularVelocity[0] = positionTmp.getX();
        vfAngularVelocity[1] = positionTmp.getY();
        vfAngularVelocity[2] = positionTmp.getZ();
