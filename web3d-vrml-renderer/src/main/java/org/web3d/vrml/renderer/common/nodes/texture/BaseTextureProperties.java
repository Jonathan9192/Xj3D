...
public abstract class BaseTextureProperties extends AbstractNode implements VRMLTextureProperties2DNodeType {
    ...
    static {
        ...
        idx = new Integer(FIELD_BOUNDARY_MODE_R);
        ...
        maxfMap = new HashMap<String, Integer>();
        ...
        minfMap = new HashMap<String, Integer>();
        ...
        aniMap = new HashMap<String, Integer>();
    ...
    protected BaseTextureProperties(VRMLNodeType node) {
        ...
        try {
            ...
            vfBorderColor[0] = field.floatArrayValue[0];
            vfBorderColor[1] = field.floatArrayValue[1];
            vfBorderColor[2] = field.floatArrayValue[2];
            vfBorderColor[3] = field.floatArrayValue[3];
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_BORDER_COLOR:
                fieldData.clear();
                fieldData.floatArrayValue = vfBorderColor;
    ...
    public int getBoundaryModeS() {
        return bmMap.get(vfBoundaryModeS).intValue();
    }
    ...
    public int getBoundaryModeT() {
        return bmMap.get(vfBoundaryModeT).intValue();
    }
    ...
    public int getMagnificationFilter() {
        return maxfMap.get(vfMagnificationFilter).intValue();
    }
    ...
    public int getMinificationFilter() {
        return minfMap.get(vfMinificationFilter).intValue();
    }
    ...
    public int getAnisotropicMode() {
        return aniMap.get(vfAnisotropicMode).intValue();
    }
