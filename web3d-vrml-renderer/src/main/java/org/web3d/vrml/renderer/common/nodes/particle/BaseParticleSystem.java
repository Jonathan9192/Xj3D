...
public abstract class BaseParticleSystem extends AbstractNode
    ...
    private static final Map<String, Integer> geomTypeMap;
    ...
    private List<VRMLNodeType> physicsNodes;
    ...
    static {
        ...
        geomTypeMap = new HashMap<String, Integer>();
    ...
    protected BaseParticleSystem() {
        ...
        physicsNodes = new ArrayList<VRMLNodeType>();
    }
    ...
    protected BaseParticleSystem(VRMLNodeType node) {
        ...
        try {
            ...
            Integer geom = geomTypeMap.get(vfGeometryType);
   ...
   //----------------------------------------------------------
    ...
    public void setupFinished() {
        ...
        for(int i = 0; i < num_physics_nodes; i++) {
            vfPhysics[i] = physicsNodes.get(i);
    ...
    public void setValue(int index, float[] value, int numValid)
        ...
        switch(index) {
            ...
            case FIELD_COLOR_KEY:
	        if(!inSetup)
	            throwInitOnlyWriteException("colorKey");
	        ...
	        if(!inSetup)
	            throwInitOnlyWriteException("texCoordKey");
    ...
    public void setValue(int index, VRMLNodeType child)
        ...
        switch(index) {
            ...
            case FIELD_COLOR_RAMP:
	        if(!inSetup)
	            throwInitOnlyWriteException("colorRamp");
	        ...
	        if(!inSetup)
	            throwInitOnlyWriteException("texCoorRamp");
            ...
            case FIELD_EMITTER:
	        if(!inSetup)
	            throwInitOnlyWriteException("emitter");
            ...
            case FIELD_PHYSICS:
	        if(!inSetup)
	            throwInitOnlyWriteException("physics");
