...
public class OGLHAnimHumanoid extends BaseHAnimHumanoid
     ...
     */
    private static final HashSet<String> hardwareCapableGeom;
     ...
     */
    static {
        hardwareCapableGeom = new HashSet<String>();
        ...
        Boolean prop = AccessController.doPrivileged(
    ...
    private void checkFactoryChoice() {
        ...
        for(int i = 0; i < num_skins; i++) {
            VRMLNodeType node = vfSkin.get(i);
