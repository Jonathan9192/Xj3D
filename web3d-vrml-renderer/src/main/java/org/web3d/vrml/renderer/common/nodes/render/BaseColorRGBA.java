 ...
 */
public class BaseColorRGBA extends BaseGeometricPropertyNode
    ...
    protected BaseColorRGBA() {
        ...
        vfColor = FieldConstants.EMPTY_MFCOLORRGBA;
     ...
     */
    protected BaseColorRGBA(VRMLNodeType node) {
        this();
        ...
        try {
            ...
            if (field.numElements != 0) {
                vfColor = new float[field.numElements * 4];
                System.arraycopy(field.floatArrayValue, 0, vfColor, 0,
                               field.numElements * 4);

                numColor = field.numElements * 4;
            }
     ...
     * be one of 1, 2, 3 or 4. ColorRGBA node returns 4 component colour
     * values.
     *
     * @return The value 4
     */
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_COLOR:
                ...
                fieldData.numElements = numColor / 4;
                break;
