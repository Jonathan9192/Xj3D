...
public abstract class BaseBindableNode extends AbstractNode
    ...
    private List<VRMLBindableNodeListener> listeners;
    ...
    protected BaseBindableNode(String name) {
        ...
        listeners = new ArrayList<VRMLBindableNodeListener>();
        vfIsBound = false;
        notifyPending = false;
    }
    ...
    public void addBindableNodeListener(VRMLBindableNodeListener l) {
        ...
        boolean send_notify = (listeners.isEmpty()) && notifyPending;
    ...
    protected void fireIsBoundChanged(boolean isActive) {
        ...
        for(int i = 0; i < size; i++) {
            try {
                ...
                System.err.println("Error sending node bound message: "
                                   + e.getMessage());
                e.printStackTrace();
            }
        }
