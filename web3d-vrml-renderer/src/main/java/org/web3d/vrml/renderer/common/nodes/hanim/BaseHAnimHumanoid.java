...
public abstract class BaseHAnimHumanoid extends AbstractNode
    ...
    protected List<VRMLNodeType> vfJoints;

    /** exposedField MFNode segments */
    protected List<VRMLNodeType> vfSegments;

    /** exposedField MFNode sites */
    protected List<VRMLHAnimNodeType> vfSites;

    /** exposedField MFNode skeleton */
    protected List<VRMLHAnimNodeType> vfSkeleton;

    /** exposedField MFNode skin */
    protected List<VRMLNodeType> vfSkin;

    /** exposedField MFNode viewpoints */
    protected List<VRMLNodeType> vfViewpoints;
    ...
    public BaseHAnimHumanoid() {
        ...
        vfJoints = new ArrayList<VRMLNodeType>();
        vfSegments = new ArrayList<VRMLNodeType>();
        vfSites = new ArrayList<VRMLHAnimNodeType>();
        vfSkeleton = new ArrayList<VRMLHAnimNodeType>();
        vfSkin = new ArrayList<VRMLNodeType>();
        vfViewpoints = new ArrayList<VRMLNodeType>();
    ...
    public void setHAnimFactory(HAnimFactory fac) {
        ...
        {
            VRMLHAnimNodeType skel = vfSkeleton.get(i);
        ...
        {
            VRMLHAnimNodeType site = vfSites.get(i);
        ...
        {
            VRMLHAnimNodeType skel = vfSkeleton.get(i);
            skel_list[i] = skel.getHAnimObject();
        }
        ...
        for(int i = 0; i < num_sites; i++)
        {
            VRMLHAnimNodeType site = vfSkeleton.get(i);
    ...
    protected void addSiteNode(VRMLNodeType node)
        ...
        vfSites.add((VRMLHAnimNodeType) node);
    ...
    protected void addSkeletonNode(VRMLNodeType node)
        ...
        vfSkeleton.add((VRMLHAnimNodeType) node);
