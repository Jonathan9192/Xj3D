 ...
 */
public class BaseGeoLCCParameters extends BaseGeoSRFTParametersNode {
    ...
    /** The last index of the nodes used by the GeoLCCParameters */
    ...
    static {
        ...
        fieldMap.put("originLongitude", new Integer(FIELD_ORIGIN_LATITUDE));
    }
     ...
     * X3D specification.
     */
    public BaseGeoLCCParameters() {
        super("GeoLCCParameters");
     ...
     */
    public BaseGeoLCCParameters(VRMLNodeType node) {
        this();
