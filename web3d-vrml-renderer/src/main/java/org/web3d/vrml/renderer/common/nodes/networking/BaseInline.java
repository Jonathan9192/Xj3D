...
public class BaseInline extends AbstractNode
    ...
    private static final HashSet<String> validVrmlTypes;
    ...
    private Map<String, VRMLNode> exportProxyNodes;
    ...
    static {
        ...
        fieldMap = new HashMap<String, Integer>(LAST_INLINE_INDEX + 1);
        ...
        validVrmlTypes = new HashSet<String>();
     ...
     */
    public void setImportNodes(Map<String, VRMLNode> imports) {
     ...
     *
     * @param newUrl The list of urls to set or null
     */
...
// as clearing the import mappings.
        ...
        Map<String, String> export_map = scene.getExports();
        Map<String, VRMLNode> def_map = scene.getDEFNodes();

        Set<String> set = exportProxyNodes.keySet();
        Iterator<String> itr = set.iterator();

        while(itr.hasNext()) {
            String import_name = itr.next();
            String export_name = export_map.get(import_name);
            ...
            ImportNodeProxy proxy = (ImportNodeProxy) exportProxyNodes.get(import_name);
    ...
    public void setErrorReporter(ErrorReporter reporter) {
        ...
        if(exportProxyNodes != null) {
            ...
            while(itr.hasNext()) {
                ...
                ImportNodeProxy proxy = (ImportNodeProxy) exportProxyNodes.get(name);
                proxy.setErrorReporter(errorReporter);
            }
        }
    }
     ...
     * The derived class should do all its work before calling this method.
     *
