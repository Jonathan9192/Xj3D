...
class AreaManager {
    ...
    private HashSet<OGLAreaListener> activeObjects;

    /** The newly visible sensors this frame. */
    private HashSet<OGLAreaListener> newObjects;
    ...
    AreaManager() {
        ...
        activeObjects = new HashSet<OGLAreaListener>();
        newObjects = new HashSet<OGLAreaListener>();
    ...
    void processFrame(Point3f pos,
        ...
        // Swap over lists
        HashSet<OGLAreaListener> tmp = activeObjects;
