 ...
 */
public abstract class BaseElevationGrid extends AbstractNode
    ...
    protected static final int FIELD_HEIGHT = LAST_NODE_INDEX + 8;

    /** Index of the normalPerVertex field */
    protected static final int FIELD_NORMALPERVERTEX = LAST_NODE_INDEX + 9;

    /** Index of the solid field */
    protected static final int FIELD_SOLID = LAST_NODE_INDEX + 10;

    /** Index of the xDimension field */
    protected static final int FIELD_XDIMENSION = LAST_NODE_INDEX + 11;

    /** Index of the xSpacing field */
    protected static final int FIELD_XSPACING = LAST_NODE_INDEX + 12;

    /** Index of the zDimension field */
    protected static final int FIELD_ZDIMENSION = LAST_NODE_INDEX + 13;

    /** Index of the zSpacing field */
    protected static final int FIELD_ZSPACING = LAST_NODE_INDEX + 14;

    /** The last field index used by this class */
    protected static final int LAST_ELEVATIONGRID_INDEX = FIELD_ZSPACING;
    ...
    protected BaseElevationGrid() {
        ...
        vfHeight = FieldConstants.EMPTY_MFFLOAT;
        heightLen = 0;
        vfCreaseAngle = 0;
        vfXDimension = 0;
        vfXSpacing = 1.0f;
        ...
        localColors = false;
        localColorsListeners = new ArrayList<LocalColorsListener>(1);
    }
     ...
     */
    protected BaseElevationGrid(VRMLNodeType node) {
        this();
        ...
        try {
            ...
            field = node.getFieldValue(index);
            vfXSpacing = field.floatValue;

            index = node.getFieldIndex("zSpacing");
            field = node.getFieldValue(index);
            vfZSpacing = field.floatValue;

            index = node.getFieldIndex("height");
            field = node.getFieldValue(index);
            vfHeight = field.floatArrayValue;
    ...
    public VRMLFieldData getFieldValue(int index)
        ...
        switch(index) {
            ...
            case FIELD_HEIGHT:
                fieldData.clear();
                fieldData.floatArrayValue = vfHeight;
            ...
            case FIELD_XSPACING:
                fieldData.clear();
                fieldData.floatValue = vfXSpacing;
                fieldData.dataType = VRMLFieldData.FLOAT_DATA;
                break;

            case FIELD_ZSPACING:
                fieldData.clear();
                fieldData.floatValue = vfZSpacing;
                fieldData.dataType = VRMLFieldData.FLOAT_DATA;
                break;
    ...
    public void setValue(int index, int value)
        ...
        switch(index) {
            case FIELD_XDIMENSION:
                ...
                FieldValidator.checkFloatPosInfinity("ElevationGrid.xDimension", value);
                vfXDimension = value;
                break;
            ...
            case FIELD_ZDIMENSION:
                ...
                FieldValidator.checkFloatPosInfinity("ElevationGrid.zDimension", value);
                vfZDimension = value;
                break;
    ...
    public void setValue(int index, float value)
        ...
        switch(index) {
            case FIELD_CREASEANGLE:
                ...
                FieldValidator.checkFloatPosInfinity("ElevationGrid.creaseAngle",value);
                vfCreaseAngle = value;
                break;
            ...
            case FIELD_XSPACING:
                ...
                FieldValidator.checkFloatPosInfinity("ElevationGrid.xSpacing",value);
                vfXSpacing = value;
                break;
            ...
            case FIELD_ZSPACING:
                ...
                FieldValidator.checkFloatPosInfinity("ElevationGrid.zSpacing",value);
                vfZSpacing = value;
                break;
     ...
     * This would be used to set MFDouble, SFVec2d, SFVec3d etc field types.
     *
     * @param index The index of destination field to set
     * @param value The new value to use for the node
    ...
    protected void setHeight(float[] value, int numValid) {
        if(vfHeight.length < numValid)
            vfHeight = new float[numValid];

        System.arraycopy(value, 0, vfHeight, 0, numValid);
