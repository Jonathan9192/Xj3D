 ...
 */
public abstract class BaseWire extends AbstractNode implements VRMLBREPNodeType {
     ...
     */
    protected static final int FIELD_EDGE = LAST_NODE_INDEX + 1;

    /**
     * Last index used by this base node
     */
    protected static final int LAST_INDEX = FIELD_EDGE;
     ...
     */
    protected List<VRMLNodeType> vfEdges;
    ...
    static {
        ...
        nodeFields = new int[]{FIELD_METADATA, FIELD_EDGE};
        ...
        fieldDecl[FIELD_EDGE] = new VRMLFieldDeclaration(
                FieldConstants.EXPOSEDFIELD, "MFNode", "edge");
        ...
        idx = new Integer(FIELD_EDGE);
        fieldMap.put("edge", idx);
        fieldMap.put("set_edge", idx);
        fieldMap.put("attrib_edge", idx);
    ...
    public BaseWire() {
        ...
        vfEdges = new ArrayList<VRMLNodeType>();
    }

    public BaseWire(VRMLNodeType node) {
        this();
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch (index) {
            ...
            case FIELD_EDGE:
                VRMLNodeType kids[] = new VRMLNodeType[vfEdges.size()];
                vfEdges.toArray(kids);
                fieldData.clear();
    ...
    public void setValue(int index, VRMLNodeType child)
        ...
        switch (index) {
            case FIELD_EDGE:
                if (child instanceof BaseEdge) {
                    ((BaseEdge) child).set_renderer(renderer);
