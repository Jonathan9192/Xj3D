...
public class DISXMLProtocolHandler
    ...
    private Map<DISConnectionId, DISXMLConnectionHandler> connections;

    /** A map of DIS nodes wrappers and their unique ID's  */
    private Map<DISId, NodeMapEntry> nodeMap;

    /** A map of DIS nodes wrappers and their unique ID's  */
    private Map<DISId, WriterMapEntryDX> writerMap;
    ...
    public DISXMLProtocolHandler() {
        ...
        connections = new HashMap<DISConnectionId, DISXMLConnectionHandler>();
        nodeMap = Collections.synchronizedMap(new HashMap<DISId, NodeMapEntry>());
        writerMap = Collections.synchronizedMap(new HashMap<DISId, WriterMapEntryDX>());
...
//System.out.println("***Real Pos: " + espdu.getEntityLocationX() + " " + espdu.getEntityLocationY() + " " + espdu.getEntityLocationZ());
                    ...
                    Orientation orient = espdu.getEntityOrientation();
                    ...
                    DeadReckoningParameter drp = espdu.getDeadReckoningParameters();
...
//                dt = (currTime - node.lastTime) * 0.01f;
                ...
                DeadReckoningParameter drp = node.currEspdu.getDeadReckoningParameters();
...
//System.out.println("   Calc Pos: " + dRPosition[0] + " " + dRPosition[1] + " " + dRPosition[2]);
    ...
    private void DROrientation(EntityStatePdu espdu, float dt, float[] dROrientation) {
        ...
        Orientation eat = espdu.getEntityOrientation();
        DeadReckoningParameter drp = espdu.getDeadReckoningParameters();
        Vector3Float angularVelocity = drp.getEntityAngularVelocity();
