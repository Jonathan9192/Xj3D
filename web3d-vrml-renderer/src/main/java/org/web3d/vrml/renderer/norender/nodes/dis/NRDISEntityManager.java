...
public class NRDISEntityManager extends BaseDISEntityManager
    ...
    private ArrayList<VRMLNodeType> addedEntities;

    /** Removed entities, will become removedEntities at end of frame */
    private ArrayList<VRMLNodeType> removedEntities;
     ...
     */
    private void init() {
        addedEntities = new ArrayList<VRMLNodeType>();
        removedEntities = new ArrayList<VRMLNodeType>();
        newAddedEntities = false;
        newRemovedEntities = false;
    }
}
